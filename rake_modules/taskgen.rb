...
class TaskGen < ::Rake::TaskLib
  ...
  def setup_spec
    ...
    # Modules that failed to pass the spec tests: monitoring, network, puppetdbquery, mysql, osm, profile, stdlib, puppetmaster, rsync, service, tilerator, wdqs, systemd, wmflib, zuul, tlsproxy
