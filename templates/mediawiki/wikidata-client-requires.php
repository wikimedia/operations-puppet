...
$wgWBSettings['repoUrl'] = "<%=scope.lookupvar("role::wikidata-client::labs::wikidata_repo_url") %>";
...
$wgLBFactoryConf = array(
	...
	'hostsByName' => array(
		...
		'local1' => '<%=scope.lookupvar("role::wikidata-client::labs::wikidata_repo_ip") %>:3306',
	),
