...
QUESTIONS = [
    {
        ...
        'validator': lambda x:
            True if re.match('^[a-z_]{6,20}$', x) else False,
    ...
    },
    {
        ...
        'validator': lambda x:
            True if re.match('^[Yy]([Ee][Ss])?|[Nn]([Oo])?|$', x) else False,
        'transformer': lambda x:
            True if re.match('^[Yy]([Ee][Ss])?|$', x) else False,
    },
    {
        'qname': 'port',
    ...
    },
    {
        ...
        'validator': lambda x:
            True if re.match('^[a-z0-9]+\.svc\.(eqiad|codfw)\.wmnet$', x)
            else False,
        'transformer': lambda x: x,
    },
    {
        ...
        'qstring': 'LVS IP',
        'validator': lambda x:
            True if re.match('^10(\.[0-9]{1,3}){3}$', x) else False,
        'transformer': lambda x: x,
    },
    {
        'qname': 'point_person',
