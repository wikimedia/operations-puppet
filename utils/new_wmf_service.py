...
QUESTIONS = [
        ...
        },
        {
            ...
            'validator': lambda x: True if re.match('^[a-z0-9\s]+$', x) else False,
            'transformer': lambda x: x,
        },
        {
            'qname': 'service_node',
...
def handle_args():
    parser = argparse.ArgumentParser(description='shell helper for automating introduction of a new service')
