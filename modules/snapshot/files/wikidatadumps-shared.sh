...
function runDcat {
	php /usr/local/share/dcat/DCAT.php --config=/usr/local/share/dcat/config.json --dumpDir=/mnt/data/xmldatadumps/public/other/wikibase/wikidatawiki/ --outputDir=/mnt/data/xmldatadumps/public/other/wikibase/wikidatawiki/
}
