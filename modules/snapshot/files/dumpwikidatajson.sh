...
while [ $i -lt $shards ]; do
	php $multiversionscript extensions/Wikidata/extensions/Wikibase/repo/maintenance/dumpJson.php --wiki wikidatawiki --shard $i --sharding-factor $shards --snippet 2> /var/log/mediawiki/dumpwikidatajson | gzip > $tempDir/wikidataJson.$i.gz &
	let i++
done
