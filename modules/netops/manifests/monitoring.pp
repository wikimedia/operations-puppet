...
class netops::monitoring(
    ...
    $l3_switches_mgmt = {
        ...
        # eqiad prod
        'ssw1-d1-eqiad.mgmt' => { ipv4 => '10.65.0.74', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'ssw1-d8-eqiad.mgmt' => { ipv4 => '10.65.4.214', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-c2-eqiad.mgmt' => { ipv4 => '10.65.4.146', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-c3-eqiad.mgmt' => { ipv4 => '10.65.4.148', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-c4-eqiad.mgmt' => { ipv4 => '10.65.4.161', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-c5-eqiad.mgmt' => { ipv4 => '10.65.4.162', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-c6-eqiad.mgmt' => { ipv4 => '10.65.4.172', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-c7-eqiad.mgmt' => { ipv4 => '10.65.4.187', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d1-eqiad.mgmt' => { ipv4 => '10.65.4.208', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d2-eqiad.mgmt' => { ipv4 => '10.65.4.209', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d3-eqiad.mgmt' => { ipv4 => '10.65.4.210', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d4-eqiad.mgmt' => { ipv4 => '10.65.4.211', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d6-eqiad.mgmt' => { ipv4 => '10.65.4.212', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d7-eqiad.mgmt' => { ipv4 => '10.65.4.213', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-d8-eqiad.mgmt' => { ipv4 => '10.65.4.217', parents => ['msw1-eqiad'], ospf => false, bfd => false, os => 'SR-Linux' },
        ...
        'lsw1-e2-codfw.mgmt' => { ipv4 => '10.193.1.95', parents => ['msw2-codfw'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-e3-codfw.mgmt' => { ipv4 => '10.193.3.209', parents => ['msw2-codfw'] },
        'lsw1-e4-codfw.mgmt' => { ipv4 => '10.193.1.99', parents => ['msw2-codfw'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-e5-codfw.mgmt' => { ipv4 => '10.193.1.100', parents => ['msw2-codfw'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-f1-codfw.mgmt' => { ipv4 => '10.193.3.222', parents => ['msw2-codfw'] },
        'lsw1-f2-codfw.mgmt' => { ipv4 => '10.193.1.245', parents => ['msw2-codfw'], ospf => false, bfd => false, os => 'SR-Linux' },
        'lsw1-f3-codfw.mgmt' => { ipv4 => '10.193.3.221', parents => ['msw2-codfw'] },
        'lsw1-f4-codfw.mgmt' => { ipv4 => '10.193.1.246', parents => ['msw2-codfw'], ospf => false, bfd => false, os => 'SR-Linux' },
        # codfw cloud
