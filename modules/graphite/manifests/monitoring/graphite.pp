...
class graphite::monitoring::graphite {
    monitoring::graphite_threshold { 'carbon-frontend-relay_drops':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/graphite-eqiad?refresh=1m&orgId=1&panelId=21&fullscreen and https://grafana.wikimedia.org/dashboard/db/graphite-codfw?refresh=1m&orgId=1&panelId=21&fullscreen',
    ...
    monitoring::graphite_threshold { 'carbon-local-relay_drops':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/graphite-eqiad?refresh=1m&orgId=1&panelId=29&fullscreen and https://grafana.wikimedia.org/dashboard/db/graphite-codfw?refresh=1m&orgId=1&panelId=29&fullscreen',
    ...
    monitoring::graphite_threshold { 'carbon-cache_write_error':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/graphite-eqiad?refresh=1m&orgId=1&panelId=30&fullscreen',
    ...
    monitoring::graphite_threshold { 'carbon-cache_overflow':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/graphite-eqiad?refresh=1m&orgId=1&panelId=8&fullscreen',
    ...
    monitoring::graphite_threshold { 'carbon-cache_many_creates':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/graphite-eqiad?refresh=1m&orgId=1&panelId=9&fullscreen',
