...
local function use_local_dc()
    ...
    if promise ~= "true" and (http_method == "POST" or http_method == "PUT" or http_method == "PATCH" or http_method == "DELETE") then
        return false
    end
    ...
    if path == "/w/index.php" and query ~= nil then
        ...
        if title == "Special:OAuth/initiate" or
            ...
            title == "Special:OAuth/approve" or
            ...
            title == "Special%3AOAuth%2Fapprove" or
    ...
    if path == "/wiki/Special:OAuth/initiate" or
        ...
        path == "/wiki/Special:OAuth/approve" or
