...
DESIRED_STATE = [
    ...
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=jobrunner'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=jobrunner'},
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=ores'},
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventgate-analytics'},  # noqa
    {'eqiad': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=logstash'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=cxserver'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=cxserver'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventgate-logging-external'},  # noqa
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventgate-logging-external'},  # noqa
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=wikifeeds'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=api-ro'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=api-ro'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=appservers-rw'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=appservers-rw'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventgate-main'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventgate-main'},
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=citoid'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mathoid'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mathoid'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mobileapps'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mobileapps'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=videoscaler'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=videoscaler'},
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=wdqs-internal'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=apertium'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=apertium'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=api-rw'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=api-rw'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=echostore'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=echostore'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=kartotherian'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=kartotherian'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=proton'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=proton'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=schema'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=schema'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=swift'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=swift'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=wdqs'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=wdqs'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=sessionstore'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=sessionstore'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=swift-ro'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=swift-ro'},
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventstreams'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventstreams-internal'},  # noqa
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventstreams-internal'},  # noqa
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=recommendation-api'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=recommendation-api'},  # noqa
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=termbox'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=termbox'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=search'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=search'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=zotero'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=zotero'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=appservers-ro'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=appservers-ro'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=druid-public-broker'},  # noqa
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=parsoid-php'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=parsoid-php'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=restbase'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=restbase'},
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=eventgate-analytics-external'},  # noqa
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=thanos-query'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=thanos-query'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=thanos-swift'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=thanos-swift'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=helm-charts'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=helm-charts'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=push-notifications'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=push-notifications'},  # noqa
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=api-gateway'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=similar-users'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=similar-users'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=shellbox'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=shellbox'},
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=shellbox-constraints'},  # noqa
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=shellbox-constraints'},  # noqa
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=linkrecommendation'},  # noqa
    ...
    {'eqiad': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mwdebug'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mwdebug'},
]
