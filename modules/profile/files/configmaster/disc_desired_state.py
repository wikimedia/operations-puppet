...
DESIRED_STATE = [
    ...
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=thanos-web'},
    {'eqiad': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=thanos-web'},
    ...
    {'eqiad': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-web'},
    {'codfw': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-web'},
    {'eqiad': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-api-ext'},
    {'codfw': {'pooled': False, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-api-ext'},
    {'eqiad': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-web-ro'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-web-ro'},
    {'eqiad': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-api-ext-ro'},
    {'codfw': {'pooled': True, 'references': [], 'ttl': 300}, 'tags': 'dnsdisc=mw-api-ext-ro'},
