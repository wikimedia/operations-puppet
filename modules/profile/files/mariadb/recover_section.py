...
def parse_options():
    ...
    parser.add_argument('--replicate', help='Enable binlog on import, for imports to a master that have to be replicated (but makes load slower)', type=bool, default=False)
