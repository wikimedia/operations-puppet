"""
Helper script to update test dblists in this directory. Based on the production dblists,
this script determines a minimum subset of interesting wikis (at least one from every
dblist), then creates dblists with this subset of wikis.

NB. the 'source' variable may need to be modified to point to the actual location of the production dblists.
"""
