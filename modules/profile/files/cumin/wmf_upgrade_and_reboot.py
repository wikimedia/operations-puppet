...
def main():
    ...
    if args.depool_cmd and not run_cumin(args.host, [args.depool_cmd]):
    ...
    run_cumin(args.host, ['apt -y full-upgrade'], timeout=300)
    ...
    lib.wait_puppet_run(args.host, start=reboot_time)

    # Repool
    if args.repool_cmd and not run_cumin(args.host, [args.repool_cmd]):
