...
def set_pxe_boot(host, mgmt, retries=0):
    """Set the host to boot into PXE at the next boot and verify the setting was applied.

    This function retries 3 times.

    Arguments:
    host    -- the host to set to boot from PXE
    mgmt    -- the management interface of the host
    retries -- a integer to keep track of nested retries [optional, default: 0]
    """
