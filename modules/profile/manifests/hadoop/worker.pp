...
class profile::hadoop::worker(
    ...
    if $monitoring_enabled {
        ...
        monitoring::check_prometheus { 'analytics_hadoop_hdfs_datanode':
            ...
            dashboard_links => ["https://grafana.wikimedia.org/d/000000585/hadoop?var-hadoop_cluster=${cluster_name}&panelId=1&fullscreen&orgId=1"],
        ...
        monitoring::check_prometheus { 'analytics_hadoop_yarn_nodemanager':
            ...
            dashboard_links => ["https://grafana.wikimedia.org/d/000000585/hadoop?var-hadoop_cluster=${cluster_name}&orgId=1&panelId=17&fullscreen"],
