...
class profile::hadoop::master(
    ...
    if $monitoring_enabled {
        ...
        monitoring::check_prometheus { 'hadoop-hdfs-percent-used':
            ...
            query           => "scalar(Hadoop_NameNode_CapacityRemainingGB{instance=${::hostname}:10080}[60m])",
            warning         => 200000,
            critical        => 100000,
        ...
        monitoring::check_prometheus { 'hadoop-hdfs-corrupt-blocks':
            ...
            query           => "scalar(Hadoop_NameNode_CorruptBlocks{instance=${::hostname}:10080}[60m])",
            warning         => 2,
            critical        => 5,
            contact_group   => 'analytics',
            prometheus_url  => "http://prometheus.svc.${::site}.wmnet/analytics",
        ...
        monitoring::check_prometheus { 'hadoop-hdfs-missing-blocks':
            ...
            query           => "scalar(Hadoop_NameNode_MissingBlocks{instance=${::hostname}:10080}[60m])",
            warning         => 2,
            critical        => 5,
            contact_group   => 'analytics',
            prometheus_url  => "http://prometheus.svc.${::site}.wmnet/analytics",
