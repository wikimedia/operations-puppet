...
class profile::hadoop::common (
    ...
    $mapreduce_reduce_memory_mb               = hiera('profile::hadoop::common::mapreduce_reduce_memory_mb'),
    $mapreduce_reduce_java_opts               = hiera('profile::hadoop::common::mapreduce_reduce_java_opts'),
