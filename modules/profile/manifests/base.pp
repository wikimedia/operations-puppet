class profile::base(
    ...
    $dns_alt_names = hiera('profile::base::dns_alt_names'),
    $use_apt_proxy = hiera('profile::base::use_apt_proxy'),
    $domain_search = hiera('profile::base::domain_search'),
    ...
    $check_disk_options = hiera('profile::base::check_disk_options'),
    $check_disk_critical = hiera('profile::base::check_disk_critical'),
) {
