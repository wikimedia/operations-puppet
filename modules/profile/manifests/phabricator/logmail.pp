...
class profile::phabricator::logmail (
    ...
    # weekly tech news mail (T368460, T373952, T428290)
    phabricator::logmail {'tech_news_weekly_stats':
        ensure           => $logmail_ensure,
        rcpt_address     => [ 'nwilson@wikimedia.org', 'jjonsson@wikimedia.org', 'bevellin@wikimedia.org', 'uzoma@wikimedia.org', 'stei@wikimedia.org', 'sbreslow-ctr@wikimedia.org'],
        sndr_address     => 'aklapper@wikimedia.org',
        weekday          => 'Thursday',
        hour             => 12,
        require          => Package[$deploy_target],
