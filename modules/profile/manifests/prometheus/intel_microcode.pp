...
class profile::prometheus::intel_microcode (
    $ensure = hiera('profile::prometheus::intel_microcode::ensure', 'present'),
    $outfile = hiera('profile::prometheus::intel_microcode::outfile', '/var/lib/prometheus/node.d/intel_microcode.prom'),
) {
