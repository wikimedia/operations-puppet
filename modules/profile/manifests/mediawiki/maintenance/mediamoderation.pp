...
class profile::mediawiki::maintenance::mediamoderation {
    ...
    profile::mediawiki::periodic_job { 'mediamoderation-updateMetrics':
        command  => '/usr/local/bin/foreachwikiindblist /srv/mediawiki/dblists/mediamoderation.dblist extensions/MediaModeration/maintenance/updateMetrics.php --verbose',
        interval => '*-*-* 04:32:00',
    }
}
