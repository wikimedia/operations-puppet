...
class profile::mediawiki::maintenance::refreshlinks {
    ...
    profile::mediawiki::maintenance::refreshlinks::periodic_job { ['s1@1', 's2@2', 's3@3', 's4@4', 's5@5', 's6@6', 's7@7', 's8@8']: }
    profile::mediawiki::maintenance::refreshlinks::periodic_job { ['wikitech@9']: ensure => absent}
}
