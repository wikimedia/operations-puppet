class profile::mediawiki::maintenance::startupregistrystats(
    ...
    profile::mediawiki::periodic_job { 'startupregistrystats-testwiki':
        command               => '/usr/local/bin/mwscript extensions/WikimediaMaintenance/maintenance/blameStartupRegistry.php --wiki testwiki --record-stats',
        interval              => '*:10',
        cron_schedule         => '10 * * * *',
        team                  => $team,
    ...
    profile::mediawiki::periodic_job { 'startupregistrystats-mediawikiwiki':
        command               => '/usr/local/bin/mwscript extensions/WikimediaMaintenance/maintenance/blameStartupRegistry.php --wiki mediawikiwiki --record-stats',
        interval              => '*:15',
        cron_schedule         => '15 * * * *',
        team                  => $team,
        script_label          => 'blameStartupRegistry.php',
    ...
    profile::mediawiki::periodic_job { 'startupregistrystats':
        command               => '/usr/local/bin/foreachwikiindblist large extensions/WikimediaMaintenance/maintenance/blameStartupRegistry.php --record-stats',
        interval              => '*:35',
        cron_schedule         => '35 * * * *',
        team                  => $team,
        script_label          => 'blameStartupRegistry.php',
