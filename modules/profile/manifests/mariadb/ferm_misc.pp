...
class profile::mariadb::ferm_misc (
    ...
    ferm::service { 'idp_staging':
        ...
        port    => '3306',
        notrack => true,
        srange  => '@resolve((idp-test1002.wikimedia.org idp-test2002.wikimedia.org idp-test1004.wikimedia.org idp-test2004.wikimedia.org))',
    }
    ...
    ferm::service { 'idp':
        ...
        port    => '3306',
        notrack => true,
        srange  => '@resolve((idp1003.wikimedia.org idp2003.wikimedia.org))',
    }
}
