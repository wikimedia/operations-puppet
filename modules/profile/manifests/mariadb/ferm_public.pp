# ferm define for publicly available database instances
# Two ports are opened here:
# The main, production use port, which by default is 3306, but
# could be any other, usually in the 3310-3330 or 3350-3369 range.
...
define profile::mariadb::ferm_public (
    Stdlib::Port $port = 3306,
) {
    if $port == 3306 {
        $rule_name = 'mariadb_public'
    } else {
