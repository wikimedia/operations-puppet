...
class profile::zookeeper::server (
    ...
    if $is_critical {
        ...
        monitoring::graphite_threshold { 'zookeeper-client-connections':
            ...
            description_suffix => "https://grafana.wikimedia.org/dashboard/db/zookeeper?refresh=5m&orgId=1&panelId=6&fullscreen&var-cluster=${cluster_name}&var-zookeeper_hosts=All",
