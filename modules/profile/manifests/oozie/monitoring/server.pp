...
class profile::oozie::monitoring::server(
    ...
    $jmx_exporter_config_file = '/etc/hive/prometheus_oozie_server_jmx_exporter.yaml'
    ...
    profile::prometheus::jmx_exporter { "oozie_server_${::hostname}":
        ...
        source           => 'puppet:///modules/profile/hive/prometheus_oozie_server_jmx_exporter.yaml',
    }
}