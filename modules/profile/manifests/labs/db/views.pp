...
class profile::labs::db::views (
    $view_user = hiera('profile::labs::db::maintainviews::user'),
    $view_pass = hiera('profile::labs::db::maintainviews::db_pass'),
    $idx_user = hiera('profile::labs::db::maintainindexes::user'),
    $idx_pass = hiera('profile::labs::db::maintainindexes::db_pass'),
){
