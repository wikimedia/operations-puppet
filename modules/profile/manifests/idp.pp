...
class profile::idp(
    ...
    String[1]                         $tgc_signing_key             = lookup('profile::idp::tgc_signing_key'),
    String[1]                         $tgc_encryption_key          = lookup('profile::idp::tgc_encryption_key'),
    ...
    String[1]                         $webflow_signing_key         = lookup('profile::idp::webflow_signing_key'),
    String[1]                         $webflow_encryption_key      = lookup('profile::idp::webflow_encryption_key'),
    String[1]                         $u2f_signing_key             = lookup('profile::idp::u2f_signing_key'),
    String[1]                         $u2f_encryption_key          = lookup('profile::idp::u2f_encryption_key'),
    String[1]                         $web_authn_signing_key       = lookup('profile::idp::web_authn_signing_key'),
    String[1]                         $web_authn_encryption_key    = lookup('profile::idp::web_authn_encryption_key'),
    String[1]                         $oauth_crypto_signing_key    = lookup('profile::idp::oauth_crypto_signing_key'),
    String[1]                         $oauth_crypto_encryption_key = lookup('profile::idp::oauth_crypto_encryption_key'),
    String[1]                         $oauth_token_signing_key     = lookup('profile::idp::oauth_token_signing_key'),
    String[1]                         $oauth_token_encryption_key  = lookup('profile::idp::oauth_token_encryption_key'),
    String[1]                         $oauth_session_encryption_key = lookup('profile::idp::oauth_session_encryption_key'),
    String[1]                         $oauth_session_signing_key   = lookup('profile::idp::oauth_session_signing_key'),
    String[1]                         $authn_pac4j_encryption_key  = lookup('profile::idp::authn_pac4j_encryption_key'),
    String[1]                         $authn_pac4j_signing_key     = lookup('profile::idp::authn_pac4j_signing_key'),
    ...
    Stdlib::Fqdn                      $webauthn_relying_party    = lookup('profile::idp::webauthn_relying_party'),
    ...
    class { 'apereo_cas':
        ...
        oidc_id_token_claims         => $oidc_id_token_claims,
        theme                        => $theme
    }
