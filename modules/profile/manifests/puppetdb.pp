...
class profile::puppetdb (
    ...
    # TODO: rename to facts-blocklist whe               n on 6.13.0 - T254646
    ...
    Optional[Prometheus::Pdb_resource_exporter::Config] $pdb_resource_exporter_config = lookup('profile::puppetdb::pdb_resource_exporter_config'),
) {
    ...
    if $pdb_resource_exporter_config {
