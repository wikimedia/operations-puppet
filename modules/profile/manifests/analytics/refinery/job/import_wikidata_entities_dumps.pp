...
class profile::analytics::refinery::job::import_wikidata_entities_dumps (
    ...
    profile::analytics::refinery::job::import_wikibase_dumps_config { 'refinery-import-wikidata-all-json-dumps':
    ...
    profile::analytics::refinery::job::import_wikibase_dumps_config { 'refinery-import-wikidata-all-ttl-dumps':
        ensure            => $ensure_timers,
    ...
    profile::analytics::refinery::job::import_wikibase_dumps_config { 'refinery-import-wikidata-lexemes-ttl-dumps':
        ensure            => $ensure_timers,
