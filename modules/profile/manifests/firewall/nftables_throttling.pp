...
# @throttle_requests number of requests clients are allowed to do in a 1 minute time frame
...
class profile::firewall::nftables_throttling (
    ...
    Integer $throttle_requests = lookup('profile::firewall::nftables_throttling::throttle_requests',
