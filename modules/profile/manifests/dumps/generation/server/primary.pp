class profile::dumps::generation::server::primary {
    ...
    class { '::dumps::generation::server::rsyncer':
        ...
        miscremotedirs => 'dumpsdata1002.eqiad.wmnet::data/otherdumps/,labstore1006.wikimedia.org::data/xmldatadumps/public/other/,labstore1007.wikimedia.org::data/xmldatadumps/public/other/',
    }
}
