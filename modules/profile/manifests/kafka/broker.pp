...
#
# [*log_dirs*]
#   Array of Kafka log data directories.  This class manages these directories
#   but not anything above them.  You must ensure that any parent directories
#   exist outside of this class.  Hiera: profile::kafka::broker::log_dirs
#
...
class profile::kafka::broker(
    ...
    if $tls_secrets_path {
        ...
        # modules/secret/secrets/kafka/$kafka_cluster_name/$fqdn/.
        # Note that $kafka_cluster_name is likely the short cluster name, without
        # DC suffix, e.g. aggregate, main, simple, etc.
