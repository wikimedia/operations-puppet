...
# == SSL Configuration
#
# To configure SSL for Kafka brokers, you need the following files distributable by Puppet:
#
...
#
# Once these are somewhere in puppet (probably the private repository), you should set
# $ssl_enabled to true, $ssl_keystore_source and $ssl_truststore_source to their
# puppet:// source paths, and also set $ssl_password to the password used to encrypt
# the key, keystore, and truststores.
#
# The default values of $ssl_keystore_source and $ssl_truststore_source expect that you
# used cergen with the puppet_ca to generate and commit files in the private puppet
# repository in the secret module at modules/secret/files/cergen.  If you did, then you
...
#   certificate and key.
#   Default: puppet:///modules/secret/cergen/kafka_broker_${::hostname}/kafka_broker_${::hostname}.keystore.jks
...
#   Default: puppet:///modules/secret/cergen/kafka_broker_${::hostname}/puppet_ca.truststore.jks
...
class profile::kafka::broker(
    ...
    $ssl_keystore_source               = hiera('profile::kafka::broker::ssl_keystore_source', "puppet:///modules/secret/cergen/kafka_broker_${::hostname}/kafka_broker_${::hostname}.keystore.jks"),
    $ssl_truststore_source             = hiera('profile::kafka::broker::ssl_keystore_source', "puppet:///modules/secret/cergen/kafka_broker_${::hostname}/puppet_ca.truststore.jks"),
