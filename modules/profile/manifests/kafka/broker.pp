...
class profile::kafka::broker(
    ...
    $ssl_keystore_secrets_path         = hiera('profile::kafka::broker::ssl_keystore_source', "certificates/kafka_broker_${::hostname}/kafka_broker_${::hostname}.keystore.jks"),
    $ssl_truststore_secrets_path       = hiera('profile::kafka::broker::ssl_keystore_source', "certificates/kafka_broker_${::hostname}/truststore.jks"),
