...
class profile::kafka::broker::monitoring (
    ...
    $prometheus_labels = "cluster=kafka_${cluster},instance=${::hostname}:${prometheus_jmx_exporter_port},job=jmx_kafka"
    ...
    monitoring::check_prometheus { 'kafka_broker_under_replicated_partitions':
        ...
        metric      => "scalar(avg_over_time(kafka_server_replicamanager_underreplicatedpartitions{${prometheus_labels}}[30m]))",
        warning        => 5,
        critical       => 10,
    ...
    monitoring::check_prometheus { 'kafka_broker_replica_max_lag':
        ...
        metric      => "scalar(avg_over_time(kafka_server_replicafetchermanager_maxlag{${prometheus_labels}}[30m]))"
