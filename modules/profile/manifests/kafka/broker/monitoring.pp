...
class profile::kafka::broker::monitoring (
    ...
    # https://grafana.wikimedia.org/dashboard/db/prometheus-kafka?refresh=5m&panelId=29&fullscreen&orgId=1
    ...
    # https://grafana.wikimedia.org/dashboard/db/prometheus-kafka?panelId=16&fullscreen&orgId=1
