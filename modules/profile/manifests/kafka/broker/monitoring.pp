...
class profile::kafka::broker::monitoring (
    ...
    monitoring::check_prometheus { 'kafka_broker_under_replicated_partitions':
        ...
        dashboard_links => ["https://grafana.wikimedia.org/dashboard/db/prometheus-kafka?panelId=29&fullscreen&orgId=1&var-datasource=${::site}%20prometheus%2Fops&var-cluster=${cluster}&var-kafka_brokers=${::hostname}"],
    ...
    monitoring::check_prometheus { 'kafka_broker_replica_max_lag':
        ...
        dashboard_links => ["https://grafana.wikimedia.org/dashboard/db/prometheus-kafka?panelId=16&fullscreen&orgId=1&var-datasource=${::site}%20prometheus%2Fops&var-cluster=${cluster}&var-kafka_brokers=${::hostname}"],
