class profile::openstack::eqiad1::keystone::service(
    ...
    Array[Stdlib::IP::Address::V4::CIDR] $instances_ip_range = lookup('profile::openstack::eqiad1::keystone::instances_ip_range', {default_value => ['0.0.0.0/0']}),
    ...
    class {'::profile::openstack::base::keystone::service':
        ...
        instances_ip_range                    => $instances_ip_range,
