class profile::openstack::eqiad1::rabbitmq(
    ...
    String $octavia_rabbit_user = lookup('profile::openstack::eqiad1::octavia::rabbit_user'),
    String $octavia_rabbit_password = lookup('profile::openstack::eqiad1::octavia::rabbit_pass'),
