class profile::openstack::eqiad1::puppetmaster::encapi(
    ...
    String[1] $git_repository_url = lookup('profile::openstack::eqiad1::puppetmaster::encapi::git_repository_url'),
    String[1] $git_repository_ssh_key = lookup('profile::openstack::eqiad1::puppetmaster::encapi::git_repository_ssh_key'),
    Stdlib::Fqdn $git_updater_active_host = lookup('profile::openstack::eqiad1::puppetmaster::encapi::git_updater_active_host'),
