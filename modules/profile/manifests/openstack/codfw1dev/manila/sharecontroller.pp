class profile::openstack::codfw1dev::manila::sharecontroller (
    ...
    Stdlib::Port        $api_bind_port                = lookup('profile::openstack::codfw1dev::manila::api_bind_port'),
    ...
    String              $network_id                   = lookup('profile::openstack::codfw1dev::manila::network_id'),
    String              $subnet_id                    = lookup('profile::openstack::codfw1dev::manila::subnet_id'),
    ...
    class { 'profile::openstack::base::manila::sharecontroller':
        version                      => $version,
        region                       => $region,
