class profile::openstack::codfw1dev::nova::vendordataapi::service(
    String $version = lookup('profile::openstack::codfw1dev::version'),
    Stdlib::Port $vendordata_bind_port = lookup('profile::openstack::codfw1dev::nova::vendordata_listen_port'),
