...
class profile::openstack::codfw1dev::octavia(
    ...
    String $octavia_project_id = lookup('profile::openstack::codfw1dev::octavia::octavia_project_id'),
    ...
    String $amphora_flavor = lookup('profile::openstack::codfw1dev::octavia::amphora_flavor'),
