...
class profile::openstack::codfw1dev::rabbitmq(
    ...
    String $octavia_rabbit_user = lookup('profile::openstack::codfw1dev::octavia::rabbit_user'),
    String $octavia_rabbit_password = lookup('profile::openstack::codfw1dev::octavia::rabbit_pass'),
    ...
    class {'::profile::openstack::base::rabbitmq':
        ...
        octavia_rabbit_user       => $octavia_rabbit_user,
        octavia_rabbit_password   => $octavia_rabbit_password,
