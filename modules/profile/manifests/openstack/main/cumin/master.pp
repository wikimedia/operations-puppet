class profile::openstack::main::cumin::master(
    ...
    $openstack_project = hiera('novaconfig::observer_project'),
    $openstack_username = hiera('novaconfig::observer_user'),
    $openstack_password = hiera('novaconfig::observer_password'),
    ) {
