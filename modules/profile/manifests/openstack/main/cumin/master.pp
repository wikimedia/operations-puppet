    ...
    $project_ssh_priv_key_path = hiera('profile::openstack::main::cumin::project_ssh_priv_key_path'),
        ...
        if os_version('debian == jessie') {
            apt::pin { 'cumin-openstack-deps':
                package  => 'python3-keystoneauth1 python3-keystoneclient python3-novaclient python3-debtcollector python3-keyring python3-oslo.config python3-oslo.i18n python3-oslo.serialization python3-oslo.utils python3-pbr python3-positional python3-requests-kerberos python3-stevedore',
