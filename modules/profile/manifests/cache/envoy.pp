class profile::cache::envoy(
    ...
    Float                         $upstream_idle_timeout     = lookup('profile::cache::envoy::upstream_idle_timeout'),
    ...
    Float                         $delayed_close_timeout     = lookup('profile::cache::envoy::delayed_close_timeout'),
    ...
    envoyproxy::tls_terminator { "${tls_port}": # lint:ignore:only_variable_string
        ...
        circuit_breakers_config   => 'disabled',
        ...
        delayed_close_timeout     => $delayed_close_timeout,
