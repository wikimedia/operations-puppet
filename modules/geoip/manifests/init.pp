...
# data_provider is 'puppet', which means the .dat files will be synced
# from the puppetmaster.  A data_provider of 'maxmind'
# will download the files directly from MaxMind.
#
# You should use a provider of 'maxmind' on your puppet master
