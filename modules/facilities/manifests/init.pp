...
class facilities (
    ...
    facilities::monitor_pdu_1phase { 'ps1-bw27-esams':
        ip    => '10.80.128.33',
        # PoPs don't have row diversity, using rack
        row   => 'BW27',
        site  => 'esams',
    ...
    facilities::monitor_pdu_1phase { 'ps1-by27-esams':
        ip    => '10.80.128.34',
        # PoPs don't have row diversity, using rack
        row   => 'BY27',
        site  => 'esams',
    ...
    facilities::monitor_pdu_3phase { 'ps1-e5-eqiad':
        ip    => '10.65.2.49',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e6-eqiad':
        ip    => '10.65.2.50',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e7-eqiad':
        ip    => '10.65.2.51',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e8-eqiad':
        ip    => '10.65.2.52',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e9-eqiad':
        ip    => '10.65.4.225',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e10-eqiad':
        ip    => '10.65.6.10',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e11-eqiad':
        ip    => '10.65.6.11',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e12-eqiad':
        ip    => '10.65.6.12',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e15-eqiad':
        ip    => '10.65.4.227',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-e16-eqiad':
        ip    => '10.65.4.228',
        row   => 'e',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f1-eqiad':
        ip    => '10.65.2.53',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f2-eqiad':
        ip    => '10.65.2.54',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f3-eqiad':
        ip    => '10.65.2.55',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f4-eqiad':
        ip    => '10.65.2.56',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f5-eqiad':
        ip    => '10.65.2.57',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f6-eqiad':
        ip    => '10.65.2.58',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f7-eqiad':
        ip    => '10.65.2.59',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
    }
    facilities::monitor_pdu_3phase { 'ps1-f8-eqiad':
        ip    => '10.65.2.60',
        row   => 'f',
        site  => 'eqiad',
        model => 'sentry4',
