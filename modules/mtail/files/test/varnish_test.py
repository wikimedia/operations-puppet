...
class VarnishBackendTest(unittest.TestCase):
    ...
    def testRespStatus(self):
        ...
        self.assertIn(('le=0.01,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=0.1,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=1.0,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=2.0,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=4.0,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=8.0,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=16.0,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=32.0,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
        self.assertIn(('le=+Inf,status=301,method=GET,backend=be_cp1065_eqiad_wmnet', 1), bucket_samples)
