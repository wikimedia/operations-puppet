...
def get_mgmt(host):
    """ Return the FQDN of the management console of a host
...
def reimage_host(puppetmaster_host, hosts, ipmi_password):
    ...
    for host, result in proxy_command(
            'reimage_host', puppetmaster_host, hosts_commands,
...
def run(args, user):
    ...
    # Start the reimage
    hosts = reimage_host(puppetmaster_host, hosts, ipmi_password=ipmi_password)
