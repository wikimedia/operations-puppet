...
# Modified by Filippo Giunchedi <fgiunchedi@wikimedia.org> and Denisse
# <adenisse@wikimedia.org> to support Python 3. Changes are also public domain.
...
class EchoBot(ib3_auth.SASL, SingleServerIRCBot):
    def __init__(self, chans, nickname, server, port=6667, ssl=False, ident_passwd=None):
        ...
        SingleServerIRCBot.__init__(
            self, [(server, port)], nickname, 'IRC echo bot', **kwargs)
...
parser = argparse.ArgumentParser(conflict_handler='resolve',
                                 prog='ircecho',
                                 description='IRC echo bot, with optional file input support.')
parser.add_argument('--ident_passwd_file', dest='ident_passwd_file',
