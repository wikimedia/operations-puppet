...
class EchoBot(SingleServerIRCBot):
    def __init__(self, chans, nickname, server, port=6667, ssl=False, nickserv_pass):
...
parser.set_usage('ircecho [--infile=<filename>] <channel> <nickname> <server> [[+]port] <nickserv_pass>')
