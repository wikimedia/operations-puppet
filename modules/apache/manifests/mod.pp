...
class apache::mod::access_compat { if os_version('ubuntu >= 13.10') { apache::mod_conf { 'access_compat': } } }
class apache::mod::proxy_fcgi    { if os_version('ubuntu >= 13.10') { apache::mod_conf { 'proxy_fcgi':    } } }
