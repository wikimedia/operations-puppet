class dataset::dirs {
    ...
    $relative_other_wikibase_wikidatawiki = 'other/wikibase/wikidatawiki'
    ...
    file { "$publicdir/$relative_other_wikibase_wikidatawiki":
        mode   => '0755',
        ensure => 'directory',
        owner  => 'datasets',
        group  => 'datasets',
    ...
    file { "$publicdir/wikidatawiki/entities":
        ...
        target => '../$relative_other_wikibase_wikidatawiki'
    }
