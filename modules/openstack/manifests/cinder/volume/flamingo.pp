...
class openstack::cinder::volume::flamingo(
    $version,
    ...
    file {
        ...
        '/etc/init.d/cinder-volume':
            source  => 'puppet:///modules/openstack/flamingo/cinder/cinder-volume',
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
    ...
    file { '/etc/cinder/cinder-volume.conf':
        content   => template('openstack/flamingo/cinder/cinder-volume.conf.erb'),
        owner     => 'cinder',
        group     => 'cinder',
        mode      => '0440',
        show_diff => false,
