class openstack::placement::service::victoria(
    ...
    file {
        '/etc/placement/placement.conf':
            content   => template('openstack/victoria/placement/placement.conf.erb'),
            owner     => 'placement',
            group     => 'nogroup',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/init.d/placement-api':
            content => template('openstack/victoria/placement/placement-api.erb'),
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
            notify  => Service['placement-api'],
