...
class openstack::nova::api::service::yoga(
    ...
    file { '/etc/init.d/nova-api':
        content => template('openstack/yoga/nova/api/nova-api'),
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
    ...
    file {$patch_file:
        source => 'puppet:///modules/openstack/yoga/nova/hacks/servers.py.patch',
        owner  => 'root',
        group  => 'root',
        mode   => '0644',
    }
    ...
    file { '/etc/init.d/nova-api-metadata':
        content => template('openstack/yoga/nova/api/nova-api-metadata'),
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
    ...
    file { '/etc/nova/nova-api-metadata-uwsgi.ini':
        content => template('openstack/yoga/nova/api/nova-api-metadata-uwsgi.ini.erb'),
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
        notify  => Service['nova-api-metadata'],
    ...
    file { '/etc/nova/nova-api-uwsgi.ini':
        content => template('openstack/yoga/nova/api/nova-api-uwsgi.ini.erb'),
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
        notify  => Service['nova-api-metadata'],
