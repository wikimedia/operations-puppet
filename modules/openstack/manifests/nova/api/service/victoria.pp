class openstack::nova::api::service::victoria(
    ...
    file { '/etc/init.d/nova-api':
        content => template('openstack/victoria/nova/api/nova-api'),
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
    ...
    file { '/usr/lib/python3/dist-packages/nova/api/openstack/compute/servers.py':
        ...
        group   => 'root',
        mode    => '0644',
        source  => 'puppet:///modules/openstack/victoria/nova/hacks/servers.py',
        require => Package['nova-api'];
    }

    file { '/etc/init.d/nova-api-metadata':
        content => template('openstack/victoria/nova/api/nova-api-metadata'),
        owner   => 'root',
        group   => 'root',
        mode    => '0755',
