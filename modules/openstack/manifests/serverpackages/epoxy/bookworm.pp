...
class openstack::serverpackages::epoxy::bookworm(
){
    ...
    apt::pin { 'openstack-epoxy-bookworm-bpo':
    ...
    apt::pin { 'openstack-epoxy-bookworm-bpo-nochange':
        package  => join($bookworm_bpo_nochange_packages, ' '),
        pin      => 'release n=bookworm-epoxy-backports-nochange',
        priority => 1002,
    }
