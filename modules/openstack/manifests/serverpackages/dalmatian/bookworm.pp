...
class openstack::serverpackages::dalmatian::bookworm(
){
    ...
    apt::pin { 'openstack-dalmatian-bookworm-bpo':
    ...
    apt::pin { 'openstack-dalmatian-bookworm-bpo-nochange':
        package  => join($bookworm_bpo_nochange_packages, ' '),
        pin      => 'release n=bookworm-dalmatian-backports-nochange',
        priority => 1002,
    }
