...
class openstack::serverpackages::bobcat::bookworm(
){
    ...
    apt::pin { 'openstack-bobcat-bookworm-bpo':
    ...
    apt::pin { 'openstack-bobcat-bookworm-bpo-nochange':
        package  => join($bookworm_bpo_nochange_packages, ' '),
        pin      => 'release n=bookworm-bobcat-backports-nochange',
        priority => 1002,
    }
