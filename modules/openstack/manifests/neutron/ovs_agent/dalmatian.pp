...
class openstack::neutron::ovs_agent::dalmatian (
    ...
    file { '/etc/neutron/plugins/ml2/openvswitch_agent.ini':
        ...
        group   => 'neutron',
        mode    => '0640',
        content => template('openstack/dalmatian/neutron/plugins/ml2/openvswitch_agent.ini.erb'),
