...
class openstack::neutron::common::dalmatian(
    ...
    file { '/etc/neutron/neutron.conf':
            ...
            mode      => '0660',
            show_diff => false,
            content   => template('openstack/dalmatian/neutron/neutron.conf.erb'),
    ...
    file { '/etc/neutron/policy.yaml':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/dalmatian/neutron/policy.yaml',
            require => Package['neutron-common'];
    }
    ...
    file { '/etc/neutron/plugins/ml2/ml2_conf.ini':
        ...
        group   => 'neutron',
        mode    => '0744',
        content => template('openstack/dalmatian/neutron/plugins/ml2/ml2_conf.ini.erb'),
        require => Package['neutron-common'];
    }
}
