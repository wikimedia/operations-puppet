...
class openstack::neutron::common::dalmation(
    ...
    class { "openstack::neutron::common::dalmation::${::lsbdistcodename}": }
    ...
    file { '/etc/neutron/neutron.conf':
            ...
            mode      => '0660',
            show_diff => false,
            content   => template('openstack/dalmation/neutron/neutron.conf.erb'),
    ...
    file { '/etc/neutron/policy.yaml':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/dalmation/neutron/policy.yaml',
            require => Package['neutron-common'];
    }
    ...
    file { '/etc/neutron/plugins/ml2/ml2_conf.ini':
        ...
        group   => 'neutron',
        mode    => '0744',
        content => template('openstack/dalmation/neutron/plugins/ml2/ml2_conf.ini.erb'),
        require => Package['neutron-common'];
    }
}
