...
class openstack::neutron::common::epoxy(
    ...
    file { '/etc/neutron/neutron.conf':
            ...
            mode      => '0660',
            show_diff => false,
            content   => template('openstack/epoxy/neutron/neutron.conf.erb'),
    ...
    file { '/etc/neutron/plugins/ml2/ml2_conf.ini':
        ...
        group   => 'neutron',
        mode    => '0744',
        content => template('openstack/epoxy/neutron/plugins/ml2/ml2_conf.ini.erb'),
        require => Package['neutron-common'];
    }
}
