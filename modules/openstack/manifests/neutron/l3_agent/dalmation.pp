...
class openstack::neutron::l3_agent::dalmation(
    $report_interval,
) {
    class { "openstack::neutron::l3_agent::dalmation::${::lsbdistcodename}": }

    file { '/etc/neutron/l3_agent.ini':
            owner   => 'neutron',
            group   => 'neutron',
            mode    => '0640',
            content => template('openstack/dalmation/neutron/l3_agent.ini.erb'),
