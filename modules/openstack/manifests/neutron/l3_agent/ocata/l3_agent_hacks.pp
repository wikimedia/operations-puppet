...
class openstack::neutron::l3_agent::ocata::l3_agent_hacks() {

    file { '/usr/lib/python2.7/dist-packages/neutron/conf/agent/l3/config.py':
            owner  => 'root',
            group  => 'root',
            mode   => '0644',
            source => 'puppet:///modules/openstack/ocata/neutron/l3/config.py',
    }
    ...
    file { '/usr/lib/python2.7/dist-packages/neutron/agent/l3/router_info.py':
            ...
            group  => 'root',
            mode   => '0644',
            source => 'puppet:///modules/openstack/ocata/neutron/l3/router_info.py',
    }
}
