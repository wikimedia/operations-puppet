class openstack::neutron::l3_agent::victoria(
    $report_interval,
) {
    class { "openstack::neutron::l3_agent::victoria::${::lsbdistcodename}": }

    file { '/etc/neutron/l3_agent.ini':
            owner   => 'neutron',
            group   => 'neutron',
            mode    => '0640',
            content => template('openstack/victoria/neutron/l3_agent.ini.erb'),
