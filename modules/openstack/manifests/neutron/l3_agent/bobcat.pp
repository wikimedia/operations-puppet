...
class openstack::neutron::l3_agent::bobcat(
    $report_interval,
    Enum['linuxbridge', 'openvswitch'] $interface_driver,
) {
    class { "openstack::neutron::l3_agent::bobcat::${::lsbdistcodename}": }

    file { '/etc/neutron/l3_agent.ini':
            owner   => 'neutron',
            group   => 'neutron',
            mode    => '0640',
            content => template('openstack/bobcat/neutron/l3_agent.ini.erb'),
