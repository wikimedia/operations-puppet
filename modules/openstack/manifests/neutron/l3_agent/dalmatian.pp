...
class openstack::neutron::l3_agent::dalmatian(
    $report_interval,
) {
    class { "openstack::neutron::l3_agent::dalmatian::${::lsbdistcodename}": }

    file { '/etc/neutron/l3_agent.ini':
            owner   => 'neutron',
            group   => 'neutron',
            mode    => '0640',
            content => template('openstack/dalmatian/neutron/l3_agent.ini.erb'),
