...
class openstack::neutron::l3_agent::victoria::l3_agent_hacks() {

    file { '/usr/lib/python3/dist-packages/neutron/conf/agent/l3/config.py':
            owner   => 'root',
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/victoria/neutron/l3/config.py',
    ...
    file { '/usr/lib/python3/dist-packages/neutron/agent/l3/router_info.py':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/victoria/neutron/l3/router_info.py',
            require => Package['neutron-l3-agent'],
    }
}
