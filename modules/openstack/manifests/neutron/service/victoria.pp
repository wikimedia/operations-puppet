class openstack::neutron::service::victoria(
    ...
    file {
        '/etc/init.d/neutron-api':
            content => template('openstack/victoria/neutron/neutron-api'),
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
        ...
        '/etc/neutron/neutron-api-uwsgi.ini':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/victoria/neutron/neutron-api-uwsgi.ini',
            notify  => Service['neutron-api'],
        ...
        '/etc/neutron/api-paste.ini':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/victoria/neutron/api-paste.ini',
            notify  => Service['neutron-api'],
            require => Package['neutron-api'];
        '/var/run/neutron/':
            ensure => directory,
