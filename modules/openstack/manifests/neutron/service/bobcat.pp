...
class openstack::neutron::service::bobcat(
    ...
    file {
        '/etc/init.d/neutron-api':
            content => template('openstack/bobcat/neutron/neutron-api.erb'),
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
        ...
        '/etc/neutron/neutron-api-uwsgi.ini':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/bobcat/neutron/neutron-api-uwsgi.ini',
            notify  => Service['neutron-api'],
            require => Package['neutron-server'];
        '/etc/neutron/api-paste.ini':
            ...
            group   => 'root',
            mode    => '0644',
            source  => 'puppet:///modules/openstack/bobcat/neutron/api-paste.ini',
            notify  => Service['neutron-api'],
            require => Package['neutron-server'];
        '/var/run/neutron/':
            ensure => directory,
