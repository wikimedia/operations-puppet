...
class openstack::horizon::service(
    ...
    file { '/usr/lib/python2.7/dist-packages/openstack_auth/plugin/wmtotp.py':
        source  => "puppet:///modules/openstack/${openstack_version}/horizon/openstack_auth_wmtotp.py",
        owner   => 'root',
        group   => 'root',
    ...
    file { '/usr/lib/python2.7/dist-packages/openstack_auth/forms.py':
        source  => "puppet:///modules/openstack/${openstack_version}/horizon/openstack_auth_forms.py",
        owner   => 'root',
        group   => 'root',
        require => Package['python-openstack-auth'],
        mode    => '0644',
