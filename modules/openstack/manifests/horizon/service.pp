class openstack::horizon::service($openstack_version='havana', $novaconfig) {
    ...
    # We want to theme things ourselves, so best to avoid the
    #  ubuntu stock theme package
    ...
    file { ['/usr/share/openstack-dashboard/openstack_dashboard/static/dashboard/img/logo.png',
        ...
        source  => 'puppet:///modules/openstack/horizon/150px-Wikimedia_labs_dashboard_logo.png',
        owner   => 'horizon',
        group   => 'horizon',
        require => Package['openstack-dashboard'],
        mode    => '0644',
    ...
    file { '/usr/share/openstack-dashboard/openstack_dashboard/static/dashboard/img/favicon.ico':
        source  => 'puppet:///modules/openstack/horizon/favicon.ico',
        owner   => 'horizon',
        group   => 'horizon',
        require => Package['openstack-dashboard'],
        mode    => '0644',
