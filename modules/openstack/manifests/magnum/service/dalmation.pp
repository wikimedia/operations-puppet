...
class openstack::magnum::service::dalmation(
    String $db_user,
    String $region,
    ...
    file {
        '/etc/magnum/magnum.conf':
            content   => template('openstack/dalmation/magnum/magnum.conf.erb'),
            owner     => 'magnum',
            group     => 'magnum',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/magnum/policy.yaml':
            source  => 'puppet:///modules/openstack/dalmation/magnum/policy.yaml',
            owner   => 'root',
            group   => 'root',
            mode    => '0644',
            notify  => Service['magnum-api', 'magnum-conductor'],
        ...
        '/etc/init.d/magnum-api':
            content => template('openstack/dalmation/magnum/magnum-api.erb'),
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
    }
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/magnum/drivers/common/templates/kubernetes/fragments/start-container-agent.sh':
        source  => 'puppet:///modules/openstack/dalmation/magnum/hacks/drivers/common/templates/kubernetes/fragments/start-container-agent.sh.patch',
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/magnum/drivers/k8s_fedora_coreos_v1/templates/fcct-config.yaml':
        source  => 'puppet:///modules/openstack/dalmation/magnum/hacks/drivers/k8s_fedora_coreos_v1/templates/fcct-config.yaml.patch',
        require => Package['magnum-api'],
        notify  => Service['magnum-api'],
    }
    openstack::patch { '/usr/lib/python3/dist-packages/magnum/db/sqlalchemy/models.py':
        source  => 'puppet:///modules/openstack/dalmation/magnum/hacks/db/sqlalchemy/models.py.patch',
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/magnum/db/sqlalchemy/api.py':
        source  => 'puppet:///modules/openstack/dalmation/magnum/hacks/db/sqlalchemy/api.py.patch',
        require => Package['magnum-conductor'],
        notify  => Service['magnum-conductor'],
    }
    openstack::patch { '/usr/lib/python3/dist-packages/oslo_db/sqlalchemy/enginefacade.py':
        source  => 'puppet:///modules/openstack/dalmation/magnum/hacks/oslodb/sqlalchemy/enginefacade.py.patch',
        require => Package['magnum-conductor'],
        notify  => Service['magnum-conductor'],
    }
}
