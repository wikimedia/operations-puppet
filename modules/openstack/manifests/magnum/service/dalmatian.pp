...
class openstack::magnum::service::dalmatian(
    String $db_user,
    String $region,
    ...
    file {
        '/etc/magnum/magnum.conf':
            content   => template('openstack/dalmatian/magnum/magnum.conf.erb'),
            owner     => 'magnum',
            group     => 'magnum',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/magnum/policy.yaml':
            source  => 'puppet:///modules/openstack/dalmatian/magnum/policy.yaml',
            owner   => 'root',
            group   => 'root',
            mode    => '0644',
            notify  => Service['magnum-api', 'magnum-conductor'],
        ...
        '/etc/init.d/magnum-api':
            content => template('openstack/dalmatian/magnum/magnum-api.erb'),
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
    }
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/magnum/drivers/common/templates/kubernetes/fragments/start-container-agent.sh':
        source  => 'puppet:///modules/openstack/dalmatian/magnum/hacks/drivers/common/templates/kubernetes/fragments/start-container-agent.sh.patch',
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/magnum/drivers/k8s_fedora_coreos_v1/templates/fcct-config.yaml':
        source  => 'puppet:///modules/openstack/dalmatian/magnum/hacks/drivers/k8s_fedora_coreos_v1/templates/fcct-config.yaml.patch',
        require => Package['magnum-api'],
        notify  => Service['magnum-api'],
    }
}
