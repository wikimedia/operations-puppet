...
class openstack::magnum::service::antelope(
    String $db_user,
    String $region,
    ...
    file {
        '/etc/magnum/magnum.conf':
            content   => template('openstack/antelope/magnum/magnum.conf.erb'),
            owner     => 'magnum',
            group     => 'magnum',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/magnum/policy.yaml':
            source  => 'puppet:///modules/openstack/antelope/magnum/policy.yaml',
            owner   => 'root',
            group   => 'root',
            mode    => '0644',
            notify  => Service['magnum-api', 'magnum-conductor'],
        ...
        '/etc/init.d/magnum-api':
            content => template('openstack/antelope/magnum/magnum-api.erb'),
            owner   => 'root',
            group   => 'root',
            mode    => '0755',
    }
