...
class openstack::trove::service::caracal(
    ...
    file {
        '/etc/trove/trove.conf':
            content   => template('openstack/caracal/trove/trove.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/trove-guestagent.conf':
            content   => template('openstack/caracal/trove/trove-guestagent.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/policy.yaml':
            source  => 'puppet:///modules/openstack/caracal/trove/policy.yaml',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
            notify  => Service['trove-api', 'trove-taskmanager', 'trove-conductor'],
        ...
        '/etc/trove/api-paste.ini':
            source  => 'puppet:///modules/openstack/caracal/trove/api-paste.ini',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/trove/instance/models.py':
        source  => 'puppet:///modules/openstack/caracal/trove/hacks/instance/models.py.patch',
        require => Package['trove-api'],
        notify  => Service['trove-api', 'trove-taskmanager'],
    }

    openstack::patch { '/usr/lib/python3/dist-packages/trove/taskmanager/models.py':
        source  => 'puppet:///modules/openstack/caracal/trove/hacks/taskmanager/models.py.patch',
        require => Package['trove-api'],
        notify  => Service['trove-api', 'trove-taskmanager'],
    }
}
