...
class openstack::trove::service::epoxy(
    ...
    #
    # Magnum also seems to function better with 1.x in epoxy.
    ...
    file {
        ...
        '/etc/trove/trove-guestagent.conf':
            content   => template('openstack/epoxy/trove/trove-guestagent.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/policy.yaml':
            source  => 'puppet:///modules/openstack/epoxy/trove/policy.yaml',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
            notify  => Service['trove-api', 'trove-taskmanager', 'trove-conductor'],
        ...
        '/etc/trove/api-paste.ini':
            source  => 'puppet:///modules/openstack/epoxy/trove/api-paste.ini',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
