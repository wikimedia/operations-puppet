...
class openstack::trove::service::antelope(
    ...
    file {
        '/etc/trove/trove.conf':
            content   => template('openstack/antelope/trove/trove.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/trove-guestagent.conf':
            content   => template('openstack/antelope/trove/trove-guestagent.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/policy.yaml':
            source  => 'puppet:///modules/openstack/antelope/trove/policy.yaml',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
            notify  => Service['trove-api', 'trove-taskmanager', 'trove-conductor'],
        ...
        '/etc/trove/api-paste.ini':
            source  => 'puppet:///modules/openstack/antelope/trove/api-paste.ini',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
    ...
    file {$instance_patch_file:
        source => 'puppet:///modules/openstack/antelope/trove/hacks/instance/models.py.patch',
        owner  => 'root',
        group  => 'root',
        mode   => '0644',
    }
    ...
    file {$taskmanager_patch_file:
        source => 'puppet:///modules/openstack/antelope/trove/hacks/taskmanager/models.py.patch',
        owner  => 'root',
        group  => 'root',
        mode   => '0644',
    }
