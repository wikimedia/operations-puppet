...
class openstack::trove::service::flamingo(
    ...
    file {
        '/etc/trove/trove.conf':
            content   => template('openstack/flamingo/trove/trove.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/trove-guestagent.conf':
            content   => template('openstack/flamingo/trove/trove-guestagent.conf.erb'),
            owner     => 'trove',
            group     => 'trove',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/trove/policy.yaml':
            source  => 'puppet:///modules/openstack/flamingo/trove/policy.yaml',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
            notify  => Service['trove-api', 'trove-taskmanager', 'trove-conductor'],
        ...
        '/etc/trove/api-paste.ini':
            source  => 'puppet:///modules/openstack/flamingo/trove/api-paste.ini',
            owner   => 'trove',
            group   => 'trove',
            mode    => '0644',
