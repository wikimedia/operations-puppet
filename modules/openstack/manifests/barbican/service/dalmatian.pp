...
class openstack::barbican::service::dalmatian(
    ...
    file {
        '/etc/barbican/barbican.conf':
            content   => template('openstack/dalmatian/barbican/barbican.conf.erb'),
            owner     => 'barbican',
            group     => 'barbican',
            mode      => '0440',
            show_diff => false,
        ...
        '/etc/barbican/policy.yaml':
            source  => 'puppet:///modules/openstack/dalmatian/barbican/policy.yaml',
            owner   => 'root',
            group   => 'root',
            mode    => '0644',
            notify  => Service['barbican-api'],
        ...
        '/etc/init.d/barbican-api':
            ...
            group   => 'root',
            mode    => '0755',
            content => template('openstack/dalmatian/barbican/barbican-api.erb');
    }
}
