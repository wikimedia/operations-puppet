...
class openstack::clientpackages::dalmation::bookworm(
) {
    # these pull the right repos
    include openstack::serverpackages::dalmation::bookworm
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/openstack/config/loader.py':
        source  => 'puppet:///modules/openstack/dalmation/openstacksdk/hacks/allow_overriding_cloud_yaml.bookworm.patch',
