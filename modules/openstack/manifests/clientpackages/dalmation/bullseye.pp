...
class openstack::clientpackages::dalmation::bullseye(
) {
    $py3packages = [
        'python3-novaclient',
    ...
    openstack::patch { '/usr/lib/python3/dist-packages/openstack/config/loader.py':
        source  => 'puppet:///modules/openstack/dalmation/openstacksdk/hacks/allow_overriding_cloud_yaml.bullseye.patch',
