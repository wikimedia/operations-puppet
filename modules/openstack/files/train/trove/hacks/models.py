...
class instance_encryption_key_cache(object):
    ...
    def get(self, instance_id):
        if instance_id in self._table:
            ...
            # WMF HACK: these next two lines didn't make it
            # into the train package but we need them:
            # ( https://review.opendev.org/c/openstack/trove/+/702842 )
