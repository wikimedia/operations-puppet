...
## Environment ##
This script relies on access to the Nova REST API, and takes info about
it through environment variables OS_USERNAME, OS_PASSWORD & OS_AUTH_URL.
On labs controllers, these can all be set by sourcing /root/novanev.sh
"""
import os
import sys
import argparse
...
if __name__ == '__main__':
    ...
    classification = classify_instances(creds,
                                        config['project'],
                                        config['classifier'])
