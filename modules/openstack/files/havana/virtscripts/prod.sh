...
### puppet:///modules/openstack/havana/virtscripts/prod.sh
#####################################################################

set -x

# Using token auth env variables
SERVICE_ENDPOINT=http://labcontrol1002.wikimedia.org:35357/v2.0/
...
GLANCE_PUBLIC_URL="http://labcontrol1002.wikimedia.org:9292/v1"
GLANCE_ADMIN_URL=$GLANCE_PUBLIC_URL
GLANCE_INTERNAL_URL=$GLANCE_PUBLIC_URL

KEYSTONE_PUBLIC_URL="http://labcontrol1002.wikimedia.org:5000/v2.0"
KEYSTONE_ADMIN_URL="http://labcontrol1002.wikimedia.org:35357/v2.0"
KEYSTONE_INTERNAL_URL=$KEYSTONE_PUBLIC_URL

NEUTRON_PUBLIC_URL="http://labcontrol1002.wikimedia.org:9696"
