...
class MemcachedDriver(coordination.CoordinationDriverCachedRunWatchers,
    ...
    #  (AGB) This and the next free functions have an upstream patch
    #  applied by puppet:
    #
    # https://review.opendev.org/#/c/601632
    #
    # this fixes encoding issues that would otherwise arise in python3.
    #
    # Hopefully this will be applied upstream in S.
