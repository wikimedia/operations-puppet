...
#
# By default, the plug-in directory is </usr/lib/eventlogging>, but
# another path may be configured by setting EVENTLOGGING_PLUGIN_DIR
# in the environment.
#
# === Parameters
#
...
define eventlogging::plugin(
    ...
    file { "/usr/lib/eventlogging/${basename}.py":
        ensure  => $ensure,
        content => $content,
        source  => $source,
        require => File['/usr/lib/eventlogging'],
