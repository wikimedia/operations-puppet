...
class eventlogging::monitoring::graphite($kafka_brokers_graphite_wildcard) {
    ...
    monitoring::graphite_threshold { 'eventlogging_throughput':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/eventlogging?panelId=6&fullscreen&orgId=1',
    ...
    monitoring::graphite_threshold { 'eventlogging_overall_inserted_rate':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/eventlogging?panelId=12&fullscreen&orgId=1',
