...
class package_builder(
    ...
    File['/var/cache/pbuilder/hooks'] -> Pbuilder_hook['precise']
    File['/var/cache/pbuilder/hooks'] -> Pbuilder_hook['trusty']
    File['/var/cache/pbuilder/hooks'] -> Pbuilder_hook['jessie']
}
