...
class confluent::kafka::broker::alerts(
    ...
    monitoring::graphite_threshold { 'kafka-broker-UnderReplicatedPartitions':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/kafka?panelId=29&fullscreen&orgId=1',
    ...
    monitoring::graphite_threshold { 'kafka-broker-Replica-MaxLag':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/kafka?panelId=16&fullscreen&orgId=1',
