...
with open('/etc/wmflabs-project') as f:
    path = os.path.join('/var/lib/git/operations/production/nodes/labs/', f.readall().strip())
...
result = ldapConn.search_s('ou=hosts,dc=wikimedia,dc=org', ldap.SCOPE_SUBTREE, query)
if result:
