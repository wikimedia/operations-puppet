...
def main():
    ...
    parser.add_argument('--warning', default=3600, type=int, metavar='SECONDS',
                        help='Raise warning if writes have been frozen for more than this many seconds (default: 1h)')
    parser.add_argument('--critical', default=3600*3, type=int, metavar='SECONDS',
                        help='Raise warning if writes have been frozen for more than this many seconds (default: 3h)')
