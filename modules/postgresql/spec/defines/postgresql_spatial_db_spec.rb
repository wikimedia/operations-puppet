...
describe 'postgresql::spatialdb', :type => :define do
    ...
    context 'with ensure present' do
        ...
        it { should contain_exec('create_postgis_comments-somedb') }
    end
end
...
describe 'postgresql::spatialdb', :type => :define do
    ...
    context 'with ensure absent' do
        ...
        it { should contain_exec('drop_postgis-somedb') }
        it { should contain_exec('drop_spatial_ref_sys-somedb') }
        it { should contain_exec('drop_postgis_comments-somedb') }
    end
end
