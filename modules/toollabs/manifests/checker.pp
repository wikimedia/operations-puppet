...
class toollabs::checker inherits toollabs {
    ...
    file { ['/run/toolschecker', '/run/toolschecker/puppetcerts']:
        ensure => directory,
    ...
    #  puppet status
    file { '/run/toolschecker/puppetcerts/cert.pem':
        ensure => present,
        owner  => "${::labsproject}.toolschecker",
        group  => 'www-data',
        mode   => '0755',
    ...
    file { '/run/toolschecker/puppetcerts/key.pem':
        ensure => present,
        owner  => "${::labsproject}.toolschecker",
        group  => 'www-data',
        mode   => '0755',
    ...
    file { '/run/toolschecker/puppetcerts/ca.pem':
        ensure => present,
        owner  => "${::labsproject}.toolschecker",
        group  => 'www-data',
        mode   => '0755',
