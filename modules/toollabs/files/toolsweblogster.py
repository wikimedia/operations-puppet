...
class UrlFirstSegmentLogster(LogsterParser):
    ...
    def parse_line(self, line):
        ...
        if regMatch:
            ...
            self.combined_status[status] = self.combined_status.get(status, 0) + 1
            ...
            self.combined_httpver[httpversion] = self.combined_httpver.get(httpversion, 0) + 1
        else:
