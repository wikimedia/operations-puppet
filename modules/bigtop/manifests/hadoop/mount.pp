...
{
    Class['bigtop::hadoop'] -> Class['bigtop::hadoop::mount']

    package { 'hadoop-hdfs-fuse':
        ensure => 'installed',
    }

    $device = $::bigtop::hadoop::ha_enabled ? {
        true    => "hadoop-fuse-dfs#dfs://${::bigtop::hadoop::nameservice_id}",
        default => "hadoop-fuse-dfs#dfs://${::bigtop::hadoop::primary_namenode_host}:8020",
    }
    ...
    #
    #   Error: Could not set 'directory' on ensure: File exists - /mnt/hdfs at 36:/etc/puppet/modules/bigtop/manifests/hadoop/mount.pp
    #   ...
    #   Warning: /Stage[main]/Bigtop::Hadoop::Mount/Mount[hdfs-fuse]: Skipping because of failed dependencies
    #
