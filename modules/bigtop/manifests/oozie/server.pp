...
class bigtop::oozie::server(
    ...
    $oozie_site_template                         = 'bigtop/oozie/oozie-site.xml.erb',
    $oozie_env_template                          = 'bigtop/oozie/oozie-env.sh.erb',
    $oozie_log4j_template                        = 'bigtop/oozie/oozie-log4j.properties.erb',
    ...
    # Also require bigtop::oozie client class.
