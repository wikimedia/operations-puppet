...
class statistics::compute {
    ...
    ensure_packages([
        ...
        'nodejs',
        'openjdk-7-jdk',
        'g++-4.9',         # Requested by bearloga (Mikhail) to ensure that there is a compiler with C++11 support that can compile R package 'Boom'; see T147682 and http://stackoverflow.com/a/36034866/1091835 for more info
    ...
    ensure_packages([
        ...
        'gfortran-4.9',    # Requested by bearloga (Mikhail); see T147682 and http://stackoverflow.com/a/36034866/1091835 for more info
