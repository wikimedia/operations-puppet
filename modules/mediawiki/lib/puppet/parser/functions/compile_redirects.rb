  ...
  class Parser
    ...
    def write_apache_conf(dest)
      dest.puts <<-eos.gsub(/^ {8}/, '')
        ...
        #
        # To update it from the operations/puppet repository:
        #   1. edit redirects/redirects.dat
        #   2. run redirects/compile_redirects.rb
        #   3. commit both redirects.conf and redirects/redirects.dat
