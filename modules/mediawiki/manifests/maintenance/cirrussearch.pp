class mediawiki::maintenance::cirrussearch( $ensure = present ) {
    ...
    logrotate::conf { 'cirrus-suggest':
        ...
        content => 'puppet:///modules/mediawiki/maintenance/logrotate.d_cirrus-suggest.erb',
    }
    ...
    logrotate::conf { 'cirrus-sanitize':
        ...
        content => 'puppet:///modules/mediawiki/maintenance/logrotate.d_cirrus-sanitize.erb',
    }
}
