...
-- | while read db; do \
-- s="ALTER TABLE $db.logging ADD KEY log_comment_type (log_comment_id, log_type, log_deleted);"; \
-- echo "$s"; \
-- mysql -A $db -e "$s"; done

ALTER TABLE logging ADD KEY log_comment_type (log_comment_id, log_type, log_deleted);
