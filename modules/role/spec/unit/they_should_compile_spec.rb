...
Dir.glob(File.join(manifests_dir, '**/*.pp')).sort.each do |role_file|
    ...
    describe role_name, :type => :class do
        ...
        before(:each) {
            Puppet::Parser::Functions.newfunction(:secret, :type => :rvalue) { return '' }
            Puppet::Parser::Functions.newfunction(:ipresolve, :type => :rvalue) { return '' }
            Puppet::Parser::Functions.newfunction(:generate, :type => :rvalue) { return '' }
            Puppet::Parser::Functions.newfunction(:slice_network_constants, :type => :rvalue) { return '' }
            Puppet::Parser::Functions.newfunction(:kafka_config, :type => :rvalue) {
                return {
