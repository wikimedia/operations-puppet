class role::graphite::alerts::reqstats {
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-eqiad':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=eqiad&var-cache_type=All&var-status_type=5'],
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-esams':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=esams&var-cache_type=All&var-status_type=5'],
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-codfw':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=codfw&var-cache_type=All&var-status_type=5'],
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-ulsfo':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=ulsfo&var-cache_type=All&var-status_type=5'],
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-eqsin':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=eqsin&var-cache_type=All&var-status_type=5'],
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-text':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=All&var-cache_type=text&var-status_type=5'],
    ...
    monitoring::graphite_threshold { 'reqstats-5xx-upload':
        ...
        dashboard_links => ['https://grafana.wikimedia.org/dashboard/file/varnish-aggregate-client-status-codes.json?panelId=3&fullscreen&orgId=1&var-site=All&var-cache_type=upload&var-status_type=5'],
