...
class role::graphite::alerts {
    ...
    monitoring::graphite_anomaly { 'kafka-analytics-eqiad-broker-MessagesIn-anomaly':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/kafka?refresh=5m&panelId=6&fullscreen&orgId=1&var-cluster=analytics-eqiad&var-kafka_brokers=All&var-kafka_servers=All',
    ...
    monitoring::graphite_threshold { 'mediawiki-memcached-threshold':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/mediawiki-graphite-alerts?orgId=1&panelId=1&fullscreen',
    ...
    monitoring::graphite_threshold { 'mediawiki_error_rate':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/mediawiki-graphite-alerts?orgId=1&panelId=2&fullscreen',
    ...
    monitoring::graphite_threshold { 'mediawiki_session_loss':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/edit-count?refresh=5m&panelId=13&fullscreen&orgId=1',
    ...
    monitoring::graphite_threshold { 'mediawiki_centralauth_errors':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/mediawiki-graphite-alerts?orgId=1&panelId=3&fullscreen',
    ...
    monitoring::graphite_threshold { 'eventbus_http_error_rate':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/eventbus?refresh=1m&panelId=1&fullscreen&orgId=1',
