...
class role::graphite::alerts {
    ...
    monitoring::graphite_anomaly { 'kafka-analytics-eqiad-broker-MessagesIn-anomaly':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/kafka?panelId=6&fullscreen&orgId=1&var-cluster=analytics-eqiad&var-kafka_brokers=All&var-kafka_servers=All',
    ...
    monitoring::graphite_threshold { 'mediawiki-memcached-threshold':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/mediawiki-graphite-alerts?orgId=1&panelId=1&fullscreen',
    ...
    monitoring::graphite_threshold { 'mediawiki_error_rate':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/mediawiki-graphite-alerts?orgId=1&panelId=2&fullscreen',
    ...
    monitoring::graphite_threshold { 'mediawiki_session_loss':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/edit-count?panelId=13&fullscreen&orgId=1',
    ...
    monitoring::graphite_threshold { 'mediawiki_centralauth_errors':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/mediawiki-graphite-alerts?orgId=1&panelId=3&fullscreen',
    ...
    monitoring::graphite_threshold { 'eventbus_http_error_rate':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/eventbus?panelId=1&fullscreen&orgId=1',
