...
class role::eventbus::eventbus {
    ...
    $kafka_message_max_bytes = hiera('kafka_message_max_bytes')
    ...
    $producer_request_max_size = $kafka_message_max_bytes * 1.1
    ...
    $outputs = [
        ...
        "${kafka_base_uri}?async=False&sync_timeout=10.0&topic=${::site}.{meta[topic]}${kafka_api_version_param}&max.request.size=${producer_request_max_size}"
    ]
