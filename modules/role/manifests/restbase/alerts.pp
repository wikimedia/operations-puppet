class role::restbase::alerts {
    monitoring::graphite_threshold { 'restbase_request_5xx_rate':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase?panelId=18&fullscreen&orgId=1&var-cluster=restbase',
    ...
    monitoring::graphite_threshold { 'restbase_html_storage_hit_latency':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase?panelId=11&fullscreen&orgId=1&var-cluster=restbase',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_storage_exceptions':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase-cassandra-storage?panelId=5&fullscreen&orgId=1&var-datacenter=1&var-node=All&var-keyspace=all',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_total_hints':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase-cassandra-storage?panelId=28&fullscreen&orgId=1&var-datacenter=1&var-node=All&var-keyspace=all',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_pending_compactions':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase-cassandra-compaction?orgId=1&panelId=5&fullscreen&var-datacenter=1&var-node=All',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_tombstones_scanned':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase-cassandra-cf-tombstones-scanned?panelId=5&fullscreen&orgId=1&var-datacenter=1&var-node=All&var-quantiles=99percentile',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_pending_internal':
        ...
        description_suffix => 'https://grafana-admin.wikimedia.org/dashboard/db/restbase-cassandra-thread-pools?panelId=34&fullscreen&orgId=1&var-datacenter=1&var-node=All',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_dropped_messages':
        ...
        description_suffix => 'https://grafana-admin.wikimedia.org/dashboard/db/restbase-cassandra-dropped-messages?panelId=35&fullscreen&orgId=1&var-datacenter=1',
