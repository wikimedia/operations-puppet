class role::restbase::alerts {
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_pending_internal':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase-cassandra-thread-pools?panelId=34&fullscreen&orgId=1&var-datacenter=1&var-node=All',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_dropped_messages':
        ...
        description_suffix => 'https://grafana.wikimedia.org/dashboard/db/restbase-cassandra-dropped-messages?panelId=35&fullscreen&orgId=1&var-datacenter=1',
