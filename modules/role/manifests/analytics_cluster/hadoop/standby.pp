    ...
    if $::realm == 'production' {
        ...
        if $hadoop_namenode_heapsize {
            ...
            monitoring::graphite_threshold { 'hadoop-hdfs-namenode-heap-usaage':
                ...
                description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?orgId=1&panelId=4&fullscreen',
        ...
        if $::realm == 'production' {
            ...
            if $hadoop_resourcemanager_heapsize {
                ...
                monitoring::graphite_threshold { 'hadoop-yarn-resourcemananager-heap-usage':
                    ...
                    description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?orgId=1&panelId=12&fullscreen',
