...
class role::analytics_cluster::hadoop::master {
    ...
    if $::realm == 'production' {
        ...
        $namenode_jvm_warning_threshold  = $::cdh::hadoop::hadoop_namenode_heapsize * 0.7
        $namenode_jvm_critical_threshold = $::cdh::hadoop::hadoop_namenode_heapsize * 0.9
        ...
        $rm_jvm_warning_threshold  = $::cdh::hadoop::hadoop_heapsize * 0.7
        $rm_jvm_critical_threshold = $::cdh::hadoop::hadoop_heapsize * 0.9
