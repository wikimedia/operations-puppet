...
class role::analytics_cluster::hadoop::master {
    ...
    if $::realm == 'production' {
        ...
        monitoring::graphite_threshold { 'hadoop-hdfs-percent-used':
            ...
            description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?orgId=1&panelId=47&fullscreen',
        ...
        monitoring::graphite_threshold { 'hadoop-hdfs-corrupt-blocks':
            ...
            description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?orgId=1&panelId=39&fullscreen',
        ...
        monitoring::graphite_threshold { 'hadoop-hdfs-missing-blocks':
            ...
            description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?orgId=1&panelId=40&fullscreen',
        ...
        if $hadoop_namenode_heapsize {
            ...
            monitoring::graphite_threshold { 'hadoop-hdfs-namenode-heap-usaage':
                ...
                description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?panelId=4&fullscreen&orgId=1',
        ...
        if $hadoop_resourcemanager_heapsize {
            ...
            monitoring::graphite_threshold { 'hadoop-yarn-resourcemananager-heap-usage':
                ...
                description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?panelId=12&fullscreen&orgId=1',
