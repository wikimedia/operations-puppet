...
class role::analytics_cluster::hadoop::worker {
    ...
    if $::realm == 'production' {
        ...
        $dn_jvm_warning_threshold  = $::cdh::hadoop::hadoop_heapsize * 0.7
        $dn_jvm_critical_threshold = $::cdh::hadoop::hadoop_heapsize * 0.9
        $nm_jvm_warning_threshold  = $::cdh::hadoop::hadoop_heapsize * 0.7
        $nm_jvm_critical_threshold = $::cdh::hadoop::hadoop_heapsize * 0.9
