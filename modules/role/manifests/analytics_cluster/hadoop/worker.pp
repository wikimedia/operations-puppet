    ...
    if $::realm == 'production' {
        ...
        if $hadoop_datanode_heapsize {
            ...
            monitoring::graphite_threshold { 'analytics_hadoop_hdfs_datanode':
                ...
                description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?panelId=1&fullscreen&orgId=1',
        ...
        if $hadoop_nodemanager_heapsize {
            ...
            monitoring::graphite_threshold { 'analytics_hadoop_yarn_nodemanager':
                ...
                description_suffix => 'https://grafana.wikimedia.org/dashboard/db/analytics-hadoop?orgId=1&panelId=17&fullscreen',
