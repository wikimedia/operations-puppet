...
class role::phabricator::main {
    ...
    $phabricator_altdomain = hiera('phabricator_altdomain', undef)
    ...
    if $phabricator_altdomain == undef {
        $altdom = 'phab.wmfusercontent.org'
    } else {
        $altdom = $phabricator_altdomain
    }
    ...
    $phabricator_diffusion_ssh = hiera('phabricator_diffusion_ssh', undef)
    ...
    class { '::phabricator':
        ...
        settings         => {
            ...
            'diffusion.ssh-host'                     => $phab_diffusion_ssh,
