...
class role::labs::dnsrecursor {
    ...
    $c3_dbs = ['c3', 's3', 's5', 's6', 's7', 'dewiki',
        ...
        'dkwikimedia', 'donatewiki', 'dsbwiki', 'dtywiki', 'dvwiki',
        ...
        'hiwikiquote', 'hiwiktionary', 'hiwikiversity', 'hiwikivoyage',
        'howiki', 'hrwiki', 'hrwikibooks', 'hrwikiquote', 'hrwikisource', 'hrwiktionary',
        ...
        'jawikisource', 'jawikiversity', 'jawiktionary', 'jamwiki',
        'jbowiki', 'jbowiktionary', 'jvwiki', 'jvwiktionary',
        'kaawiki', 'kabwiki', 'kawiki', 'kawikibooks', 'kawikiquote',
        ...
        'outreachwiki', 'pa_uswikimedia', 'pagwiki', 'pamwiki', 'pawikisource',
        ...
        'pswikibooks', 'pswiktionary', 'ptwikibooks', 'ptwikimedia', 'ptwikinews',
        ...
        'wawiktionary', 'wbwikimedia', 'wikimania2005wiki', 'wikimania2006wiki',
        ...
        'wikimania2016wiki', 'wikimania2017wiki', 'wikimania2018wiki',
        ...
        'yowiktionary', 'zawiki', 'zawikibooks',
