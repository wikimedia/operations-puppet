...
class role::maps::master {
    ...
    # Limit query execution time for geoshape queries
    postgresql::query { 'set 15 seconds timeout for kartotherian':
        query       => 'ALTER ROLE kartotherian SET statement_timeout = 15000',
        refreshonly => true,
        require     => [ Postgresql::User['kartotherian'], Postgresql::Spatialdb['gis'] ],
    }
