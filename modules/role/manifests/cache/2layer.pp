class role::cache::2layer {
    ...
    varnish::setup_filesystem { unique($storage_parts): }
    ...
    $persistent_storage_args = "-s main1=persistent,/srv/${storage_parts[0]}/varnish.main1,${storage_size}G,${mma[0]} -s main2=persistent,/srv/${storage_parts[1]}/varnish.main2,${storage_size}G,${mma[1]}",
}
