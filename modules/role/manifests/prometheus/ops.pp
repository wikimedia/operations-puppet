...
class role::prometheus::ops {
    ...
    prometheus::class_config{ "varnish-upload_backendmtail_${::site}":
        dest       => "${targets_path}/varnish-upload_backendmtail_${::site}.yaml",
        site       => $::site,
        class_name => 'role::cache::upload',
        port       => '3904',
    }
    ...
    $jmx_exporter_jobs = [
      ...
      {
        'job_name'        => 'jmx_configcluster',
        'scheme'          => 'http',
        'file_sd_configs' => [
          { 'files' => [ "${targets_path}/jmx_configcluster_*.yaml" ]}
        ],
      },
    ]
    ...
    prometheus::jmx_exporter_config{ "configcluster_${::site}":
        dest       => "${targets_path}/jmx_configcluster_${::site}.yaml",
