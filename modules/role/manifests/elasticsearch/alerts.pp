class role::elasticsearch::alerts {
    monitoring::graphite_threshold { 'cirrussearch_eqiad_95th_percentile':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/elasticsearch-percentiles?panelId=19&fullscreen&orgId=1&var-cluster=eqiad&var-smoothing=1',
    ...
    monitoring::graphite_threshold { 'cirrussearch_codfw_95th_percentile':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/elasticsearch-percentiles?panelId=39&fullscreen&orgId=1&var-cluster=codfw&var-smoothing=1',
    ...
    monitoring::graphite_threshold { 'search_backend_failure_count':
        ...
        dashboard_link => 'https://grafana.wikimedia.org/dashboard/db/elasticsearch-percentiles?orgId=1&var-cluster=eqiad&var-smoothing=1&panelId=9&fullscreen',
