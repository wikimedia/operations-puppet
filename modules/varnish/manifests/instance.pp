define varnish::instance(
    ...
    if ($inst == 'backend') {
        ...
        $capabilities = 'CAP_SETUID CAP_SETGID CAP_NET_BIND_SERVICE CAP_CHOWN CAP_DAC_OVERRIDE CAP_FOWNER'
    } else {
        $capabilities = 'CAP_SETUID CAP_SETGID CAP_NET_BIND_SERVICE CAP_CHOWN'
    }
