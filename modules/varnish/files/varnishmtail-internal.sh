...
FMT="${fmt_error}\t${fmt_fetch_error}\t${fmt_timestamp_start}\t${fmt_timestamp_req}\t${fmt_timestamp_reqbody}\t${fmt_timestamp_waitinglist}\t${fmt_timestamp_fetch}\t${fmt_timestamp_process}\t${fmt_timestamp_resp}\t${fmt_timestamp_restart}\t${fmt_timestamp_pipe}\t${fmt_timestamp_pipesess}\t${fmt_timestamp_bereq}\t${fmt_timestamp_beresp}\t${fmt_timestamp_berespbody}\t${fmt_timestamp_retry}\t${fmt_timestamp_error}\t"
