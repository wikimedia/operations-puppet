...
class dstat_plugin(dstat):  # noqa F821 undefined name 'dstat'
    ...
    def varnishstat(self, frontend=False):
        """
        {'be-cache_hit': 185.61, 'be-cache_miss': 52.42, 'be-s_req': 2480.98, 'be-s_pass': 0.21, 'be-s_synth': 2242.82}
        {'fe-s_pass': 0.71, 'fe-cache_miss': 317.95, 'fe-cache_hit': 556.74, 'fe-s_synth': 2245.61, 'fe-s_req': 3121.01}
        """
