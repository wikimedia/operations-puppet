...
describe 'ipresolve' do
  it "should resolve ipv4 addresses by default" do
    should run.with_params('install1002.wikimedia.org').and_return('208.80.154.22')
  end
  it "should resolve ipv4 addresses when explicitly asked to" do
    should run.with_params('install1002.wikimedia.org', '4').and_return('208.80.154.22')
  end
  ...
  it "should be able to perform a reverse DNS lookup" do
    should run.with_params('2620:0:861:1:208:80:154:22', 'ptr').and_return('install1002.wikimedia.org')
    should run.with_params('208.80.154.22', 'ptr').and_return('install1002.wikimedia.org')
  end
