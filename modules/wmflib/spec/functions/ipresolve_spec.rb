...
describe 'ipresolve' do
  ...
  it "should resolve ipv4 addresses when explicitly asked to" do
    should run.with_params('carbon.wikimedia.org', '4').and_return('208.80.154.10')
  end

  it "should resolve ipv6 addresses" do
    should run.with_params('carbon.wikimedia.org', '6').and_return('2620::861:1:208:80:154:10')
  end

  it "should be able to perform a reverse DNS lookup" do
    should run.with_params('2620::861:1:208:80:154:10', 'ptr').and_return('carbon.wikimedia.org')
    should run.with_params('208.80.154.10', 'ptr').and_return('carbon.wikimedia.org')
  end
