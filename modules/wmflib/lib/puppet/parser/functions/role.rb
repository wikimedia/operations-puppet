...
# single role stanza, or you may encounter unexpected behaviour. If
# you do, a warning will be raised.
#
...
module Puppet::Parser::Functions
  newfunction(:role, :arity => -1) do |args|
    ...
    if rolevar
      Puppet.
        warning "Using multiple instances of the role keyword is discouraged"
    else
