...
def main():
    ...
    argparser.add_argument(
        ...
        type=str,
        nargs='+',
        help='Space separated list of globs to find log directories on disk.',
    )
    ...
    argparser.add_argument(
        ...
        type=str,
        nargs='+',
        help='''Space separated list of rotated logs extensions.  "." is prepended.
              Default: log''',
    )
    ...
    argparser.add_argument(
        '--tail-lines',
        type=int,
        help='Lines to tail if size exceeds max-copytruncate. Default: 10000',
    )
    ...
    # Convert Namespace object args to dict, and only populate keys with
    # not None values
