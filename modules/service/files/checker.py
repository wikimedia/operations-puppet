...
def fetch_url(client, url, **kw):
    ...
    try:
        ...
        raise CheckServiceError("Invalid certificate")
            ...
            # urllib3.exceptions.ConnectionError, # commented out until we can remove trusty (aka urllib3 1.7.1) support
...
class CheckService(object):
    ...
    def _spawn_downloader(self):
        ...
        """
        kw = {
        #    'retries': 1, # TODO: uncomment this once we've got rid of trusty for services
            'timeout': self._timeout
        }
