...
class jupyterhub_old (
    ...
    file { '/usr/local/sbin/deploy-jupyterhub':
        ...
        group   => 'root',
        mode    => '0555',
        content => template('jupyterhub_old/deploy-jupyterhub.sh.erb'),
    }
    ...
    systemd::service { 'jupyterhub':
        ...
        restart => true,
        content => systemd_template('jupyterhub_old')
    }
    ...
    file { "${venv_path}/nchp_config.py":
        ...
        source  => 'puppet:///modules/jupyterhub_old/nchp_config.py',
        owner   => 'root',
        group   => 'root',
        mode    => '0444',
    ...
    file { "${venv_path}/jupyterhub_config.py":
        ...
        source  => 'puppet:///modules/jupyterhub_old/jupyterhub_config.py',
        owner   => 'root',
        group   => 'root',
        mode    => '0440',
