...
def main():
    ...
    parser = argparse.ArgumentParser(description="Pontoon ENC", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument(
        "hostname",
        type=str,
        default=None,
    ...
    if stack is None:
        parser.error(f"Unable to determine stack. Tried {args.stack_file} and PONTOON_STACK.")
