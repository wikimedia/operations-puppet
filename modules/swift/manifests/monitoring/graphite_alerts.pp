define swift::monitoring::graphite_alerts (
    ...
    monitoring::graphite_threshold { "swift_${cluster}_dispersion_object":
        ...
        description_suffix => "https://grafana.wikimedia.org/dashboard/file/swift.json?panelId=8&fullscreen&orgId=1&var-DC=${cluster}",
    ...
    monitoring::graphite_threshold { "mediawiki_${cluster}_media_uploads":
        ...
        description_suffix => "https://grafana.wikimedia.org/dashboard/file/swift.json?panelId=9&fullscreen&orgId=1&var-DC=${cluster}",
