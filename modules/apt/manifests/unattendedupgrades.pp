...
#  Note: security updates can not be disabled
#
# [*unattended_distro*]
#  Bool to enable/disable non-security distro packages
#
# [*unattended_wmf*]
#  Bool to enable/disable wmf packages
#
# [*unattended_updates*]
#  Bool to enable/disable updates suite packages
