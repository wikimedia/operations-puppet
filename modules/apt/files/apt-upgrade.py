...
def register_all():
    register_novacloudstrustybackports()
    register_novacloudstrustyupdates()
    register_trustysecurity()
    register_trustywikimedia()
    register_jessiesecurity()
    register_jessiebackports()
    register_jessie()
    register_jessieupdates()
    register_jessiewikimedia()
...
def register_novacloudstrustybackports():
    name = "nova-clouds-trusty-backports"
    repo = """
deb http://nova.clouds.archive.ubuntu.com/ubuntu/ trusty-backports main restricted universe
"""
    pref = """
Package: *
...
def register_novacloudstrustyupdates():
    name = "nova-clouds-trusty-updates"
    repo = """
deb http://nova.clouds.archive.ubuntu.com/ubuntu/ trusty-updates main universe
"""
    pref = "NA"
    register_info(name, repo, pref)


def register_novacloudstrusty():
    name = "nova-clouds-trusty"
    repo = """
deb http://nova.clouds.archive.ubuntu.com/ubuntu/ trusty main universe
"""
    pref = """
Package: *
Pin: release l=Ubuntu
...
def register_trustywikimedia():
    name = "trusty-wikimedia"
    repo = """
deb http://apt.wikimedia.org/wikimedia trusty-wikimedia main universe thirdparty
"""
    pref = """
Package: *
...
def register_jessiewikimedia():
    name = "jessie-wikimedia"
    repo = """
deb http://apt.wikimedia.org/wikimedia jessie-wikimedia main contrib non-free
"""
    pref = """
Package: *
Pin: release l=Wikimedia
...
def list_registers():
    ...
    for name in sorted(InfoRegister):
