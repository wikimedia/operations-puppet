...
try:
    latest_version_url = "https://www.mediawiki.org/w/api.php?action=expandtemplates&text=%7B%7BMW_stable_release_number%7D%7D&format=json&formatversion=2&prop=wikitext"
    latest_req = requests.get(latest_version_url, verify=False)
    latest_req.raise_for_status()
    {u'expandtemplates': {u'wikitext': u'1.28.1'}}
...
try:
    static_version_url = "https://wikitech-static.wikimedia.org/w/api.php?action=query&meta=siteinfo&siprop=general&format=json"
