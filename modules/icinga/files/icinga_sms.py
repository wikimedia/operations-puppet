...
parser.add_argument("-l", "--list", action='store_true', help="List all contacts who can receive SMS.")
parser.add_argument("-lf", "--listfull", action='store_true', help="List all contacts who can receive SMS along with their addresses.")
parser.add_argument("-la", "--listall", action='store_true', help="list all contacts found in contact file")
parser.add_argument("-a", "--address", nargs=1, help="Get the address for a contact name. usage: -a <contact>")
parser.add_argument("-s", "--send", nargs=2, help="Send SMS to a contact name. usage: --send <contact> <message>")        
parser.add_argument("-sa", "--sendall", nargs=1, help="Send SMS to ALL contacts who can receive SMS. usage: --sendall <message>")
