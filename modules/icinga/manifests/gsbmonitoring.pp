class icinga::gsbmonitoring {
    ...
    @monitoring::service { 'GSB_mediawiki':
        ...
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=mediawiki.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
    @monitoring::service { 'GSB_wikibooks':
        description   => 'check google safe browsing for wikibooks.org',
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=wikibooks.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
    @monitoring::service { 'GSB_wikimedia':
        description   => 'check google safe browsing for wikimedia.org',
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=wikimedia.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
    @monitoring::service { 'GSB_wikinews':
        description   => 'check google safe browsing for wikinews.org',
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=wikinews.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
    ...
    @monitoring::service { 'GSB_wikisource':
        ...
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=wikisource.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
    @monitoring::service { 'GSB_wikiversity':
        description   => 'check google safe browsing for wikiversity.org',
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=wikiversity.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
    @monitoring::service { 'GSB_wiktionary':
        description   => 'check google safe browsing for wiktionary.org',
        check_command => 'check_https_url_for_string!www.google.com!/safebrowsing/diagnostic?site=wiktionary.org/!\'Safe Browsing has not recently seen malicious content\'',
        host          => 'google',
    }
}
