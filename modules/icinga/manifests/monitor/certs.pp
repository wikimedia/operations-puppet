...
class icinga::monitor::certs {
    ...
    monitoring::service { 'https_blog':
        ...
        check_command => 'check_ssl_http_traditional!blog.wikimedia.org',
    ...
    monitoring::service { 'https_policy':
        ...
        check_command => 'check_ssl_http_traditional!policy.wikimedia.org',
    ...
    monitoring::service { 'https_eventdonations':
        ...
        check_command => 'check_ssl_http_traditional!eventdonations.wikimedia.org',
    ...
    monitoring::service { 'https_planet':
        ...
        check_command => 'check_ssl_http_traditional!en.planet.wikimedia.org',
    ...
    monitoring::service { 'https_wmflabs':
        ...
        check_command => 'check_ssl_http_traditional!tools.wmflabs.org',
    ...
    monitoring::service { 'https_wmfusercontent':
        ...
        check_command => 'check_ssl_http_traditional!phab.wmfusercontent.org',
