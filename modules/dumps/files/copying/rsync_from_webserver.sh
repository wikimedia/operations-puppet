...
/usr/bin/rsync $args -a $excludes --exclude=/other/ /data/xmldatadumps/public/  ${desthost}::data/xmldatadumps/public/
/usr/bin/rsync $args -a $excludes /data/xmldatadumps/public/other/ ${desthost}::data/xmldatadumps/public/other/
