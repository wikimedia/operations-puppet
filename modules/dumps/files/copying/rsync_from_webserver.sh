...
/usr/bin/rsync -n -i $args -aq $excludes --exclude=/other/ /data/xmldatadumps/public/  ${desthost}::data/xmldatadumps/public/
/usr/bin/rsync -n -i $args -aq $excludes /data/xmldatadumps/public/other/ ${desthost}::data/xmldatadumps/public/other/
