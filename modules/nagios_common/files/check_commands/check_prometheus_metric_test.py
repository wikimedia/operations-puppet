...
class PrometheusCheckTest(unittest.TestCase):
    ...
    def testVectorThreshold(self):
        ...
        self.assertEqual(EX_WARNING,
                         self._check_vector(['up{foo="bar"} 11', 'up{foo="baz"} 1'], 10, 20))
        self.assertEqual(EX_CRITICAL,
                         self._check_vector(['up{foo="bar"} 21', 'up{foo="baz"} 1'], 10, 20))
