    ...
    $lvs_service_ips = {
        'production' => {
            ...
            'bits' => {
                ...
                'ulsfo' => { 'bitslb' => "198.35.26.106", 'bitslb6' => '2620:0:863:ed1a::1:a', 'bitslb6-old' => "2620:0:863:ed1a::a", 'bitssvc' => "10.2.4.23" },
            },
            'upload' => {
            ...
            'mobile' => {
                ...
                'ulsfo' => { 'mobilelb' => '198.35.26.108', 'mobilelb6' => '2620:0:863:ed1a::1:c', 'mobilelb6-old' => '2620:0:863:ed1a::c', 'mobilesvc' => '10.2.4.26'},
            },
            'swift' => {
                'pmtpa' => "10.2.1.27",
                'eqiad' => "10.2.2.27",
