...
class lvs::monitor {
    ...
    lvs::monitor_service_http { "search.svc.eqiad.wmnet": ip_address => "10.2.2.30", check_command => "check_http_url_on_port_with_string!$host!9200!/_nodes/$host|$host", contact_group => "admins" }
