...
class lvs::monitor {
    ...
    lvs::monitor_service_http { 'graphoid.svc.eqiad.wmnet': ip_address => $ip['graphoid']['eqiad'], check_command => "check_http_lvs_on_port!graphoid.svc.eqiad.wmnet!19000!/", contact_group => "admins,parsoid" }
