...
module Puppet::Parser::Functions
  newfunction(:slice_network_constants, :type => :rvalue, :arity => -2) do |args|
    ...
    if defined? requested_sphere && (requested_sphere != 'public' && requested_sphere != 'private' && requested_sphere != 'both')
        fail 'slice_network_constants() sphere can only be public/private/both'
    end
    if defined? af && (af != 'ipv4' && af != 'ipv6')
