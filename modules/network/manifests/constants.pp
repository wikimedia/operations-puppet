class network::constants {
    ...
    $production_networks_ipv4 = slice_network_constants('production', 'both', 'ipv4')
    $production_networks_ipv6 = slice_network_constants('production', 'both', 'ipv6')
    ...
    $all_network_subnets = hiera('network::all_network_subnets')
