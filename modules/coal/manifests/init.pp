...
#
# Coal 
#   1) processes and stores NavTiming metrics
#   2) Delivers metrics to performance.wikimedia.org
#
# This file contains config directives that are common to both parts
#
class coal() {
