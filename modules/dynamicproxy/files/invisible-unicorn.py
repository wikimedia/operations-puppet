...
class Dns:
    ...
    def can_use_hostname(self, project: str, hostname: str):
        ...
        return len(client.recordsets.list(zone_id, criterion={"name": hostname, "type": "A"})) == 0
...
def create_mapping(project_name):
    ...
    if route is None:
        ...
        if not dns.can_use_domain(project_name, domain):
            return "Can't use that domain", 403
