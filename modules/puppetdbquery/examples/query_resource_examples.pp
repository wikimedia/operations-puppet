...
$index = 'Class[Nova::Rabbitmq]'
$rabbit_class      = $rabbit_resources[$index]
...
$mysql_class = 'Class[Nova::Db::Mysql]'
$nova_db_host      = unique(query_nodes($mysql_class, 'fqdn'))
$nova_db_resources = query_resource($mysql_class, 'architecture=amd64')

$nova_db_class     = $nova_db_resources[$mysql_class]
