...
# $webserver      - Boolean.  If true, the apache module will be used to set up an Apache VirtualHost using mod_proxy to proxy HTTP requests to Limn.  Default: true
