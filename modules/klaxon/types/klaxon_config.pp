...
#
#  [*vo_managers_create_incident_url*]
#    [string] VictorOps-provided URL for the REST Integration
#     incident creation endpint for the manager escalation. optional
#
#  [*secret_key*]
...
type Klaxon::Klaxon_config = Struct[{
    ...
    vo_managers_create_incident_url => Optional[Stdlib::HTTPUrl],
    secret_key                      => String[1],
