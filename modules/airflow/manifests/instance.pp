...
#   Default: present
#
# [*manage_skein_certificate*]
#   If true, make sure the skein certificate is (re)generated via puppet, using our internal PKI,
#   instead of having it be manually generated via the skein CLI.
#   Note: the certificate will be generated by our cfssl PKI, opposed to the certificate we sign
#   via our Puppet CA.
define airflow::instance(
    String $service_user,
    ...
    Boolean $manage_skein_certificate   = false
) {
