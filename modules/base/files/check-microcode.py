...
def main():
    ...
    # fixed for L1TF/MDS
    blacklist_ssbd = ['bast3002', 'dbproxy1006', 'dbproxy1007', 'dbproxy1008']
    blacklist_l1tf_mds = ['es2001', 'es2002', 'es2003', 'es2004'] + blacklist_ssbd
    ...
    if 'ssbd' in expected_cpu_flags and hostname in blacklist_ssbd:
        expected_cpu_flags.remove('ssbd')

    for flag in ['flush_l1d', 'md_clear']:
        if flag in expected_cpu_flags and hostname in blacklist_l1tf_mds:
