    ...
    case debian::codename() {
        ...
        'bullseye': {
            ...
            $absent_packages = [
                ...
                'libevent-2.1-6', 'libdns-export1110', 'libisc-export1105', 'libwireshark11', 'libwiretap8', 'libwsutil9',
                'libwscodecs2', 'libperl5.28', 'libmpdec2',
            ]
            $purged_packages = []
        }
        'bookworm': {
            ...
            $absent_packages = [
                ...
                'liburing1', 'libwebp6', 'libcbor0', 'libusb-0.1-4', 'telnet',
            ]
            $purged_packages = []
        }
        default: {
