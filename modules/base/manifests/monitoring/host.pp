...
class base::monitoring::host(
    ...
    file { '/usr/local/lib/nagios/plugins/check_duplicateip.sh':
        ...
        group  => 'root',
        mode   => '0555',
        source => 'puppet:///modules/base/monitoring/check_duplicateip.sh',
    }
    ...
    ::nrpe::monitor_service { 'check_duplicateip':
        ...
        nrpe_command   => "/usr/bin/sudo /usr/local/lib/nagios/plugins/check_duplicateip.sh ${::interface_primary} ${::ipaddress}",
        check_interval => 5,
        retry_interval => 1,
