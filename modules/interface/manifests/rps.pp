...
#   "fq flow_limit 422"
# - $numa_networking
#   Whether or not NUMA optimizations should be enabled.
#   Valid values are 'off' (default) and 'on'
define interface::rps($interface=$name, $rss_pattern='', $qdisc='', $numa_networking='off') {
