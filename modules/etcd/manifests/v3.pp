...
class etcd::v3 (
    ...
    Stdlib::IP::Address::V4::Nosubnet $client_listen_ip = $facts['networking']['ip'],
    String $peer_listen_host = $facts['networking']['fqdn'],
    Stdlib::IP::Address::V4::Nosubnet $peer_listen_ip = $facts['networking']['ip'],
    ...
    Optional[String] $srv_dns = undef,
    Optional[String] $peers_list = undef,
