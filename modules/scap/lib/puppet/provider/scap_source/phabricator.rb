# Puppet phabricator provider for type `scap_source`, which is needed to set up a
...
Puppet::Type.type(:scap_source).provide(:phabricator, :parent => Puppet::Provider::Scap_source) do
