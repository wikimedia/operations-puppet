...
class puppet_compiler (
    ...
    String           $version = '2.6.0',  # can and often is overridden in horizon
    ...
    case debian::codename() {
        ...
        'bookworm': { ensure_packages(['python3-typing-extensions']) }
        default: { fail("${debian::codename()} is not supported") }
    }
    ensure_packages([
