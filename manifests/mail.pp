...
class exim {
    ...
    #       External URL to connect while HTTP POST-ing a bounced email to the MediaWiki 'bouncehandler' API
    #   - $verp_bounce_post_url:
    #       Internal URL of the wiki to which verp bounce emails are HTTP POST-ed and processed
    class roled(
        $enable_clamav=false,
