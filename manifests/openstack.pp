...
class openstack::database-server($openstack_version="diablo", $novaconfig, $keystoneconfig, $glanceconfig, $puppetconfig) {
...
class openstack::scheduler-service($openstack_version="diablo") {
...
class openstack::network-service($openstack_version="diablo") {
...
class openstack::api-service($openstack_version="diablo") {
	package {  [ "nova-api" ]:
		ensure => latest;
	}
...
class openstack::volume-service($openstack_version="diablo") {
	package { [ "nova-volume" ]:
		ensure => absent;
	}
...
class openstack::compute-service($openstack_version="diablo") {
