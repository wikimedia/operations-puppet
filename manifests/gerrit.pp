class gerrit::database-server {
	...
	## Need the client to create the database
	...
	exec {
		...
		'create_gerrit_db':
			...
			command => "/usr/bin/mysql -uroot -e \"create database ${gerrit::gerrit_config::gerrit_db_name}; ALTER DATABASE reviewdb charset=utf8;\"",
