...
class accounts {
    ...
    class otto inherits baseaccount {
        ...
        unixaccount { $realname: username => $username, uid => $uid, gid => $gid }
                ...
                if $manage_home {
                    ...
                    ssh_authorized_key { 'otto@hundchen.local':
                        ensure => 'absent',
                        user   => $username,
                        type   => 'ssh-rsa',
                        ...
                        ssh_authorized_key { 'otto@klein.local':
                        ensure => 'present',
                        user   => $username,
                        type   => 'ssh-rsa',
    ...
    class robh inherits baseaccount {
        ...
        if $manage_home {
            ...
            ssh_authorized_key { 'rob@Navi.local':
                    ensure => 'absent',
                    user   => $username,
                    type   => 'ssh-rsa',
    ...
    class leila inherits baseaccount {
        ...
        if $manage_home {
            ...
            ssh_authorized_key { 'leila@starfruit':
                ensure => 'present',
                user   => $username,
                type   => 'ssh-rsa',
