...
node /^db1(084|106|118|119|134|135|169)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# eqiad replicas
# See also db1090, db1105, db1146, db1170 below
...
# eqiad replicas
node /^db1(075|112|157|166|175)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(081|121|141|142|143|147|148|149|160)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# eqiad replicas
# See also db1090, db1098, db1101, db1170 below
...
node /^db1(090|096|098|099|101|105|113|144|146|170)\.eqiad\.wmnet/ {
...
node /^db11(56|58|59|61|62|63|64|65|67|68|72|76|77|78|79|80|81|82|83|84)\.eqiad\.wmnet$/ {
    role(insetup)
}
