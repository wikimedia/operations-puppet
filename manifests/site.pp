...
node /^db1(084|089|106|118|119|134|135)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# es1029 will replace es1016 T261717
...
# es1026 will replace es1011 T261717
node 'es1026.eqiad.wmnet' {
    role(mariadb::core)
}

# es1030 will replace es1013 T261717
node 'es1030.eqiad.wmnet' {
    role(mariadb::core)
}

# es1033 will replace es1015 T261717
...
# es1028 will replace es1014 T261717
node 'es1028.eqiad.wmnet' {
    role(mariadb::core)
}

# es1031 will replace es1017 T261717
