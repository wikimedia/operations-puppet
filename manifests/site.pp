...
node /^db2(130|145|146|153|170|174|176|188|203|212|216)\.codfw\./ {
    role(mariadb::core)
}
...
node /^wikikube-worker11(0[0-1])\.eqiad\./ {
    role(kubernetes::worker)
}
...
node /^wikikube-worker22([0-1][0-9]|2[0-3])\.codfw\./ {
    role(kubernetes::worker)
}
