...
# Wikidough (T252132)
node /^(doh200[1-2]|doh300[1-2]|malmok)\.wikimedia\.org$/ {
    role(wikidough)
}

# Wikidough Singapore (T284246)
node /^(doh500[1-2])\.wikimedia\.org$/ {
    role(insetup)
}
...
# eqiad
# pc1
node /^pc10(07)\.eqiad\.wmnet$/ {
    role(mariadb::parsercache)
}
# pc2
node /^pc10(08|10)\.eqiad\.wmnet$/ {
    role(mariadb::parsercache)
}
# pc3
