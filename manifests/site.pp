...
node /^db1(084|089|106|118|119|134|135|169)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# eqiad replicas
node /^db1(075|078|112|175)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db11(56|57|58|59|61|62|63|64|65|66|67|68|70|71|72|73|74)\.eqiad\.wmnet$/ {
    role(insetup)
}
