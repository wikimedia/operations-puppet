...
# backup cluster.
# T260411
node /^analytics104[23].eqiad.wmnet$/ {
    role(insetup)
}

# analytics1044-analytics1077 and an-worker10XX
...
node /analytics10(4[4-9]|5[0-9]|6[0-9]|7[0-7]).eqiad.wmnet/ {
...
node /^cloudvirt102[3-4]\.eqiad\.wmnet$/ {
