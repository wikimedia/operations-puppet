...
node /^cp20(4[345679]|5[13579])\.codfw\./ {
    role(cache::text)
}

node /^cp20(48|5[02468])\.codfw\./ {
    role(cache::upload)
}
...
node /^cp30(6[6789]|7[012345])\.esams\./ {
    role(cache::text)
}

node /^cp30(7[6789]|8[01])\.esams\./ {
    role(cache::upload)
}
...
node /^cp50(2[789]|3[012])\.eqsin\./ {
    role(cache::upload)
}

node /^cp50(1[789]|2[0123456])\.eqsin\./ {
    role(cache::text)
}
...
node /^cp600[3-8]\.drmrs\./ {
    role(cache::upload)
}

node /^cp60(0[129]|1[0-6])\.drmrs\./ {
    role(cache::text)
}
...
node /^db1(160|199|228|238|242|244|247|248|249|252)\.eqiad\./ {
    role(mariadb::core)
}
...
node /^db1(168|173|187|201|241|282|287)\.eqiad\./ {
    role(mariadb::core)
}
...
node /^db1(069|170|174|181|190|191|194|202|227|231|236|253|284|288)\.eqiad\./ {
    role(mariadb::core)
}
...
node /^db1(192|193|209|214|226|286)\.eqiad\./ {
    role(mariadb::core)
}
...
# sanitarium hosts
node /^db1(154|155|269|270)\.eqiad\./ {
...
node /^dse-k8s-worker10(0[1-9]|1[0-9]|2[0-8])\.eqiad\./ {
    role(dse_k8s::worker)
}

# See T439220
node /^dse-k8s-worker10(39|4[0-1])\.eqiad\./ {
    role(insetup::data_platform_ferm)
}
