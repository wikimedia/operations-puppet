...
node /^db1(138|141|142|143|147|148|149|160|190|199|238|241|242|243|247)\.eqiad\./ {
    role(mariadb::core)
}
...
node /^db12(26|28|29|39|32|33|34|35|37|39|40|44|45|46|48|49)\.eqiad\./ {
    role(insetup::data_persistence)
}
## m1 shard
...
node /^mw147[2345]\.eqiad\./ {
    role(kubernetes::worker)
}
node /^mw242[0125]\.codfw\./ {
    role(kubernetes::worker)
}
node /^mw2431\.codfw\./ {
    role(kubernetes::worker)
...
node /^restbase20(1[3-9]|2[0-8])\.codfw\./ {
    role(restbase::production)
}

# new restbase nodes T349758
node /^restbase20(29|3[0-5])\.codfw\./ {
