...
node /^db2(125|138|148|175|189|204|207|225|238)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(136|137|140|147|172|179|206|210|219|237)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(124|129|151|169|180|193|214|217|224|229)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db22(23|26|28|31|32|33|34|35|36|39|40)\.codfw\./ {
    role(insetup::data_persistence)
}
...
node /^kafka-main200[4-8]\.codfw\./ {
    role(kafka::main)
}

node /^kafka-main20(09|10)\.codfw\./ {
    role(insetup::serviceops)
}
...
node /^kubernetes20(0[5-6]|1[1-7]|2[1-4]|3[26-9]|4[0-9]|5[0-3689]|60)\.codfw\./ {
    role(kubernetes::worker)
}
...
node /^wikikube-worker21(0[0-6])\.codfw\./ {
    role(kubernetes::worker)
}
