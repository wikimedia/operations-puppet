...
node /^db22(21|22|23|24|25|26|27|28|29|32|33|34|35|36|37|38|39|40)\.codfw\./ {
    role(insetup::data_persistence)
}
...
node /^kubernetes20(0[5-9]|1[0-79]|2[0-46-9]|[34][0-9]|5[0-9]|60)\.codfw\./ {
    role(kubernetes::worker)
}
...
node /^wikikube-worker20(0[1-47-9]|1[0-9]|2[0-9]|3[0-9]|4[0-2])\.codfw\./ {
    role(kubernetes::worker)
}
