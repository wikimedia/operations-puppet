...
node /^db1(083|106|118|119|134|135|164|169|184)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(069|079|124|127|136|158|167|174|178|181)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(087|109|111|114|126|172|177)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node 'ldap-replica2005.wikimedia.org' {
    role(openldap::replica)
}

node 'ldap-replica2006.wikimedia.org' {
    role(insetup)
}
...
node /^mc10(19|2[0-3]|2[5-9]|3[0-8])\.eqiad\.wmnet/ {
