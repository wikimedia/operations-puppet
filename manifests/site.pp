...
node 'stat1.wikimedia.org' {
    ...
    include accounts::lwelling     # RT 4959
...
node 'streber.wikimedia.org' {
    ...
    include base::sysctl
    include base::motd
    include base::vimconfig
    include base::standard-packages
    include base::monitoring::host
