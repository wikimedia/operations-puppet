...
# to make sure the hostname -> /datacenter/rack/row id is correct.
# This is used for Hadoop network topology awareness.
node /^an-worker1(10[0-9]|11[0-9]|12[0-9]|13[0-9]|14[0-9]|15[0-9]|16[0-8]|17[0-7]|18[7-9]|19[0-9]|20[0-8])\.eqiad\./ {
    role(analytics_cluster::hadoop::worker)
}

# Temporarily put an-worker1169 back into insetup mode for reimaging
node /^an-worker1169\.eqiad\./ {
