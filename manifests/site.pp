...
node /^db1(208|209|210|211|212|213|214|215|216|217|218|219|221|222|223|224|225)\.eqiad\.wmnet$/ {
...
node /^db1(109|111|114|126|172|177|192|193|203)\.eqiad\.wmnet$/ {
    role(mariadb::core)
}
...
## x1 shard
# eqiad
node /^db1(103|120|137|179|220)\.eqiad\.wmnet$/ {
    role(mariadb::core)
}
...
node 'miscweb1002.eqiad.wmnet', 'miscweb1003.eqiad.wmnet', 'miscweb2003.codfw.wmnet' {
    role(miscweb)
}
