...
node /^db1(084|106|118|119|134|135|163|169)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(092|087|109|111|114|126|172)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db11(56|58|59|61|64|65|67|68|76|77|78|79|80|81|82|83|84)\.eqiad\.wmnet$/ {
    role(insetup)
}
