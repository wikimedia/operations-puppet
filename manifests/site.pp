...
node 'carbon.wikimedia.org' {
    role installserver::wmf, aptrepo::wikimedia
    $cluster = 'misc'
...
node 'krypton.eqiad.wmnet' {
    ...
    role wikimania_scholarships, iegreview::app, grafana, kafka::analytics::burrow, racktables::server
    include standard
}
...
node 'netmon1001.wikimedia.org' {
    role rancid::server, librenms, servermon, torrus, smokeping
    include standard
