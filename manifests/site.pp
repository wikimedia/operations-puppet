...
# future s1 codfw sanitarium master
...
node /^db2(090|106|119|136|147|172)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
# codfw replicas
# See also db2087, db2169 and db2089 db2171 below
...
# codfw replicas
# See also db2168 and db2087 db2169 below
...
# codfw master
node 'db2161.codfw.wmnet' {
    role(mariadb::core)
}

# codfw replicas
# See also db2167 db2168 below
node /^db2(079|152|154|161|162|163|165|166)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db2(087|088|089|137|138|167|168|169|170|171)\.codfw\.wmnet/ {
    role(mariadb::core_multiinstance)
}
