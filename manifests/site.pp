...
# backup cluster.
# T260411
node /^analytics10(4[2-9]|5[0134]).eqiad.wmnet$/ {
    role(insetup)
}

# analytics1052,analytics1055-analytics1077 and an-worker10XX
...
node /analytics10(5[256789]|6[0-9]|7[0-7]).eqiad.wmnet/ {
