...
node /^db20(38|45|52|59|66|75|79|80|81|82|83|84|86)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node 'db1046.eqiad.wmnet' {
    role(mariadb::analytics,
        mariadb::misc::eventlogging::master,
        mariadb::ferm,
        mariadb::monitor::dba)
}
...
node 'dbstore1002.eqiad.wmnet' {
    ...
    role(mariadb::dbstore,
        mariadb::misc::eventlogging::pure_replica)
}
...
node /^restbase200[135]\.codfw\.wmnet$/ {
    role(restbase::production_ng)
}
