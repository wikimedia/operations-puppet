...
# codfw replicas
# See also db2085, db2167 and db2088 db2170 below
...
# eqiad master
node 'db1162.eqiad.wmnet' {
    role(mariadb::core)
}

# eqiad replicas
# See also db1105, db1146, db1170 below
node /^db1(122|129|182)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# codfw replicas
# See also db2088 db2170 and db2138 below
...
node /^db2(111|113|157)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
# codfw replicas
# See also db2087, db2169 and db2089 below
...
node /^db1(069|127|174|178|181)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# codfw replicas
# See also db2086, db2168 and db2087 db2169 below
...
# codfw replicas
# See also db2085, db2167 and db2086, db2168 below
node /^db2(152|154|161|162|163|165|166)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db2(085|086|087|088|089|137|138|167|168|169|170)\.codfw\.wmnet/ {
    role(mariadb::core_multiinstance)
}
