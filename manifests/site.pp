...
# to make sure the hostname -> /datacenter/rack/row id is correct.
# This is used for Hadoop network topology awareness.
node /^an-worker11(0[0-9]|1[0-8])\.eqiad\.wmnet$/ {
    role(analytics_cluster::hadoop::worker)
}
...
node /^db1(085|088|168|173)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db21(45|46|48|49|50|51|52)\.codfw\.wmnet$/ {
    role(insetup)
}
...
node /^db11(56|58|59|61|64|65|67|76|77|78|79|80|81|82|83|84)\.eqiad\.wmnet$/ {
    role(insetup)
}
