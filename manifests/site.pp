...
node /^db21(21|22|24|27|30|31)\.codfw\.wmnet/ {
    role(spare::system)
}
...
node /^db2(049|051|056|063|104|107|108|125|126)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db2(059|066|075|111|113|123|128)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db2(053|058|060|067|076|114|117|129)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(071|092|087|109|126)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
