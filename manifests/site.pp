...
node /^db2(103|112|116|145|146|153|174|176|194)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(131|168|173|180|187)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(069|127|136|174|178|181|191)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
# ceph storage nodes
node /^cloudcephosd10(0[1-9]|1[0-9]|2[0-8])\.eqiad\.wmnet$/ {
    role(wmcs::ceph::osd)
}

# ceph storage nodes
node /^cloudcephosd10(29|3[0-4])\.eqiad\.wmnet$/ {
    role(insetup)
}
