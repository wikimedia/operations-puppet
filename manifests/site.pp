...
node /^db1(106|118|119|134|135|163|164|169|184)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(074|129|162)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(069|079|086|127|136|174|181)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db11(56|58|67|76|78|79|82|83)\.eqiad\.wmnet$/ {
    role(insetup)
}
