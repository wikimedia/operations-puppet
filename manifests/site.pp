...
node /uone/ {
    ...
    #include admin
    class { 'admin': groups => ['analytics-users', 'statistics-users'] }
}
...
node 'stat1001.wikimedia.org' {
    ...
    class { 'admin': groups => ['statistics-web'] }
}
...
node 'stat1002.eqiad.wmnet' {
    ...
    class { 'admin': groups => ['statistics-privatedata',
                                'statistics-stat-users'] }
