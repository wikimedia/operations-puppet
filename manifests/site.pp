...
node /^db12(65|66|67|68|69|70|71|72|73|74|75|76|77|78|79|80|81|82|83|84|85|86|87|88|89)\.eqiad\./ {
    role(insetup::data_persistence_ferm)
}
...
node /^dse-k8s-worker10(0[1-9]|1[0123489]|2[01245678])\.eqiad\./ {
    role(dse_k8s::worker)
}

# Temporarily set dse-k8s-worker1023 from service. See #T414216
node /^dse-k8s-worker1023\.eqiad\./ {
    role(insetup::data_platform_ferm)
}
...
node /^clouddb10(13|14|15|16|22|24|26)\.eqiad\./ {
...
node /^clouddb10(2[7-9]|3[0-3])\.eqiad\./ {
...
node /^cloudvirt10(4[0-9]|5[0-9]|6[0-9]|7[0-7])\.eqiad\./ {
