...
# future codfw s3 sanitarium master
...
# eqiad master
node 'db1160.eqiad.wmnet' {
    role(mariadb::core)
}

# eqiad replicas
# See also db1144 and db1146 below
node /^db1(138|141|142|143|147|148|149)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db1(168|173|180)\.eqiad\.wmnet/ {
    role(mariadb::core)
}
...
node /^db2(080|084|152|154)\.codfw\.wmnet/ {
    role(mariadb::core)
}
...
node /^db21(5[8-9]|6[0-9]|7[0-4])\.codfw\.wmnet/ {
    role(insetup)
}
