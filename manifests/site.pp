...
node /^db2(054|061|068|077|120|121|122)\.codfw\.wmnet/ {
    role(mariadb::core)
    interface::add_ip6_mapped { 'main': }
}
...
# To be decommissioned # T231767
node 'db2046.codfw.wmnet' {
    role(spare::system)
}

# To be decommissioned # T231852
...
# To be decommissioned # T231407
node 'db2053.codfw.wmnet' {
    role(spare::system)
}
...
node /kafka-main100[2-5]\.eqiad\.wmnet/ {
    role(spare::system)
}
