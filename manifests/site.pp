...
node /^db2(103|116|130|145|146|153|170|174|176|188|203|212|216)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(106|110|136|137|140|147|172|179|206|210|219)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(111|123|157|171|178|192|211|213)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(108|121|122|150|168|182|218|208|220)\.codfw\./ {
    role(mariadb::core)
}
...
## s2, s6 & x1, bullseye, 10.6, to be decommed
node /^db2097\.codfw\./ {
    role(mariadb::backup_source)
}
## s7 & s8, bullseye, to be decommed
node /^db2098\.codfw\./ {
    role(mariadb::backup_source)
}
