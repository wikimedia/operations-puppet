...
node /^db1(163|169|184|186|206|207|218|219|228|232|234|235)\.eqiad\./ {
    role(mariadb::core)
}
...
node /^db2(114|117|124|129|151|169|180|193)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(108|118|120|121|122|150|168|182|218)\.codfw\./ {
    role(mariadb::core)
}
...
node /^db2(196|197|198|199|200|201|202|203|204|205|206|207|208|209|210|211|212|213|214|215|216|217|219|220)\.codfw\./ {
    role(insetup::data_persistence)
}
...
node /^mw138[0-3568]\.eqiad\./ {
  role(kubernetes::worker)
}
node /^mw139[0246]\.eqiad\./ {
  role(kubernetes::worker)
}
node /^mw1408\.eqiad\./ {
  role(kubernetes::worker)
...
node /^mw142[3-5]\.eqiad\./ {
  role(kubernetes::worker)
}
node /^mw143[0149]\.eqiad\./ {
  role(kubernetes::worker)
}
node /^mw1440\.eqiad\./ {
  role(kubernetes::worker)
...
# rack B3
node /^mw14(2[6-8])\.eqiad\./ {
    role(mediawiki::appserver::api)
}

node /^mw14(29|3[23])\.eqiad\./ {
    role(mediawiki::appserver)
}
...
# rack B3
node /^mw231[4-6]\.codfw\./ {
    role(mediawiki::appserver)
}

# rack B3
node /^mw232[0-4]\.codfw\./ {
    role(mediawiki::appserver::api)
}
