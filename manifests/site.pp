...
node /^cp10(7[68]|8[0246])\.eqiad\.wmnet$/ {
    role(cache::upload)
}
...
node /^cp20(28|3[02468])\.codfw\.wmnet$/ {
    role(cache::upload)
}

# HAProxy test T290005
node /^cp204[02]\.codfw\.wmnet$/ {
    role(cache::upload_haproxy)
}
...
node /^cp305[13579]\.esams\.wmnet$/ {
    role(cache::upload)
}

# HAProxy test T290005
node /^cp306[135]\.esams\.wmnet$/ {
    role(cache::upload_haproxy)
}
...
node /^cp40(2[1-4]|33)\.ulsfo\.wmnet$/ {
    role(cache::upload)
}

# HAProxy test
node /^cp40(2[56]|34)\.ulsfo\.wmnet$/ {
    role(cache::upload_haproxy)
}
...
node /^cp50(0[1-4]|13)\.eqsin\.wmnet$/ {
    role(cache::upload)
}

# HAProxy test T290005
node /^cp50(0[56]|14)\.eqsin\.wmnet$/ {
    role(cache::upload_haproxy)
}
