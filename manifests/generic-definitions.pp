...
class git::user {
	systemuser { "git": name => "git", groups => ["wikidev"] }
}
...
#	$owner		-	owner of $directory, default: 'git'.  git commands will be run by this user.
#	$group		-	group owner of $directory, default: 'git',
