...
# required packages and apache configs for limesurvey install
	...
	require mysql::client
	package { [ "libapache2-mod-php5", "php-pear", "php5-cli", "php5-common", "php5-gd", "php5-mysql" ]:
		ensure => latest;
}
...
class misc::contint::test {
	...
	class packages {
		...
		generic::apt::pin-package { [ php5-tidy, php5-intl, php5-pgsql ]: }
