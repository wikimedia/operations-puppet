...
class lvs::monitor {
	...
	monitor_service_lvs_http { "parsoid.svc.pmtpa.wmnet": ip_address => "10.2.1.28", check_command => "check_http_lvs_on_port!parsoid.svc.pmtpa.wmnet!8000!/_html/" }
