...
#	monitor_service_lvs_http { "ms-fe.eqiad.wmnet": ip_address => "10.2.2.27", check_command => "check_http_lvs!ms-fe.eqiad.wmnet!/monitoring/backend" }
	...
	# ulsfo -lb addresses
	monitor_service_lvs_http { "wikimedia-lb.ulsfo.wikimedia.org": ip_address => "198.35.26.96", check_command => "check_http_lvs!en.wikipedia.org!/wiki/Main_Page", critical => "false" }
	monitor_service_lvs_https { "wikimedia-lb.ulsfo.wikimedia.org": ip_address => "198.35.26.96", check_command => "check_https_url!en.wikipedia.org!/wiki/Main_Page", critical => "false" }
...
#	monitor_service_lvs_https { "bits.ulsfo.wikimedia.org": ip_address => "91.198.174.233", check_command => "check_https_url!bits.wikimedia.org!/skins-1.5/common/images/poweredby_mediawiki_88x31.png", critical => "false" }
	monitor_service_lvs_http { "wikidata-lb.ulsfo.wikimedia.org": ip_address => "198.35.26.114", check_command => "check_http_lvs!wikimediafoundation.org!/wiki/Main_Page", critical => "false" }
	monitor_service_lvs_https { "wikidata-lb.ulsfo.wikimedia.org": ip_address => "198.35.26.114", check_command => "check_https_url!wikimediafoundation.org!/wiki/Main_Page", critical => "false" }
	monitor_service_lvs_http { "wikivoyage-lb.ulsfo.wikimedia.org": ip_address => "198.35.26.115", check_command => "check_http_lvs!wikimediafoundation.org!/wiki/Main_Page", critical => "false" }
	monitor_service_lvs_https { "wikivoyage-lb.ulsfo.wikimedia.org": ip_address => "198.35.26.115", check_command => "check_https_url!wikimediafoundation.org!/wiki/Main_Page", critical => "false" }
