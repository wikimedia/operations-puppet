...
class lvs::monitor {
	...
	monitor_service_lvs_http { "wikidata-lb.pmtpa.wikimedia.org": ip_address => "208.80.152.218", check_command => "check_http_upload" }
	monitor_service_lvs_https { "wikidata-lb.pmtpa.wikimedia.org": ip_address => "208.80.152.218", check_command => "check_https_upload", critical => "false" }
	monitor_service_lvs_http { "wikivoyage-lb.pmtpa.wikimedia.org": ip_address => "208.80.152.219", check_command => "check_http_upload" }
	monitor_service_lvs_https { "wikivoyage-lb.pmtpa.wikimedia.org": ip_address => "208.80.152.219", check_command => "check_https_upload", critical => "false" }
