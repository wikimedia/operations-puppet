...
if $hostname == "spence" {
	...
	monitor_service_lvs_http { "ms-fe.pmtpa.wmnet": ip_address => "10.0.6.212", check_command => "check_http_lvs!ms-fe.pmtpa.wmnet!wikipedia/commons/thumb/2/22/Miedledorpf.jpg/180px-Miedledorpf.jpg" }
