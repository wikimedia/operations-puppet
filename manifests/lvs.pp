...
class lvs::static_labs_ips {
	...
	interface_ip { "wikimedialb": interface => "eth0", address => $lvs_services['text']['ip']['wikimedialb'] }
	interface_ip { "wikipedialb": interface => "eth0", address => $lvs_services['text']['ip']['wikipedialb'] }
