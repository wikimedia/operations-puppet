...
class role::phabricator {
    ...
    class { '::phabricator::tools':
        dbhost          => $mysql_host,
        dbslave         => $mysql_slave,
        manifest_user   => $role::phabricator::config::mysql_maniphest_user,
        manifest_pass   => $role::phabricator::config::mysql_maniphest_pass,
        app_user        => $role::phabricator::config::mysql_app_user,
        app_pass        => $role::phabricator::config::mysql_app_pass,
