...
class role::ldap::server::labs inherits role::ldap::server {
...
class role::ldap::server::production inherits role::ldap::server {
...
class role::ldap::server::corp inherits role::ldap::server {
