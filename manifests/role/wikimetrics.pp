...
class role::wikimetrics {
    ...
    logster::job { 'wikimetrics-apache-visits':
        ...
        logster_options => "-o statsd --statsd-host=labmon1001.eqiad.wmnet:8125 --metric-prefix='analytics.wikimetrics.pageviews' --parser-options '--regex=report|cohort|metrics|login|about|contact' LineCountLogster /var/log/apache2/access.wikimetrics.log"
}
