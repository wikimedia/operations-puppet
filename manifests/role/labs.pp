...
class role::labs::tools::bastion inherits role::labs::tools::config {
...
class role::labs::tools::execnode inherits role::labs::tools::config {
...
class role::labs::tools::master inherits role::labs::tools::config {
...
class role::labs::tools::shadow inherits role::labs::tools::config {
...
class role::labs::tools::webserver inherits role::labs::tools::config {
...
class role::labs::tools::webproxy inherits role::labs::tools::config {
