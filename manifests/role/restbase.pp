...
class role::restbase::alerts {
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_storage_exceptions':
        ...
        metric         => 'highestMax(movingAverage(nonNegativeDerivative(cassandra.restbase10*.org.apache.cassandra.metrics.Storage.Exceptions.count), 5), 1)',
        from           => '10min',
        warning        => '5',
        critical       => '10',
        percentage     => '50',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_total_hints':
        ...
        metric         => 'highestMax(movingAverage(nonNegativeDerivative(cassandra.restbase10*.org.apache.cassandra.metrics.Storage.TotalHints.count), 5), 1)',
        from           => '10min',
        warning        => '600',
        critical       => '1000',
        percentage     => '50',
    ...
    monitoring::graphite_threshold { 'restbase_cassandra_highest_sstables_per_read':
        ...
        metric         => 'highestMax(movingAverage(cassandra.restbase10*.org.apache.cassandra.metrics.ColumnFamily.all.SSTablesPerReadHistogram.99percentile, 5), 1)',
        from           => '10min',
        warning        => '6',
        critical       => '10',
        percentage     => '50',
        ...
        metric         => 'highestMax(movingAverage(cassandra.restbase10*.org.apache.cassandra.metrics.ColumnFamily.all.TombstoneScannedHistogram.99percentile, 5), 1)',
        from           => '10min',
        warning        => '1000',
        critical       => '1500',
        percentage     => '50',
