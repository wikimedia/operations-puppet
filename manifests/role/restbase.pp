...
class role::restbase::alerts {
    monitoring::graphite_threshold { 'restbase_request_5xx_rate':
        description   => 'RESTBase html revision 5xx req/s https://goo.gl/X68cAx',
    ...
    monitoring::graphite_threshold { 'restbase_html_storage_hit_latency':
        description   => 'RESTBase HTML revision request mean storage latency ms https://goo.gl/jx8JIQ',
    ...
    monitoring::graphite_threshold { 'restbase_html_storage_hit_latency_99p':
        description   => 'RESTBase HTML revision request 99p storage latency ms https://goo.gl/jx8JIQ',
