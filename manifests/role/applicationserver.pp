...
#		From lvs::configuration::$lvs_service_ips
	...
	## prod role classes
	class appserver{
	  system_role { "appserver": description => "Standard Apache Application server" }
	...
	class appserver::api{
	  system_role { "api_appserver": description => "Api Apache Application server" }
	...
	class appserver::bits{
	  system_role { "bits_appserver": description => "Bits Apache Application server" }
	...
	class imagescaler{
	  system_role { "imagescaler": description => "Imagescaler Application server" }
	...
	class videoscaler( $run_jobs_enabled = true ){
	  system_role { "tmh_jobrunner": description => "TMH Jobrunner Server" }
	...
	class jobrunner( $run_jobs_enabled = true ){
	  system_role { "jobrunner": description => "Standard Jobrunner Server" }
