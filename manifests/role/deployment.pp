class role::deployment::salt_masters::production {
  class { "deployment::salt_master":
    ...
    deployment_repo_urls => {
      'pmtpa' => {
        'common' => 'http://fenari.wikimedia.org/deployment/common',
        'slot0' => 'http://fenari.wikimedia.org/deployment/common/slot0',
        'slot1' => 'http://fenari.wikimedia.org/deployment/common/slot1',
      },
      'eqiad' => {
        'common' => 'http://bast1000.wikimedia.org/deployment/common',
        'slot0' => 'http://bast1000.wikimedia.org/deployment/common/slot0',
        'slot1' => 'http://bast1000.wikimedia.org/deployment/common/slot1',
      },
    },
