...
class role::deployment::deployment_servers {
  ...
  deployment::deployment_repo_dependencies_link { "l10n-slot0": "l10n.py" }
  deployment::deployment_repo_dependencies_link { "l10n-slot1": "l10n.py" }
  deployment::deployment_repo_sync_hook_link { "parsoid/Parsoid": "shared.py" }
  deployment::deployment_repo_sync_hook_link { "parsoid/config": "shared.py" }
