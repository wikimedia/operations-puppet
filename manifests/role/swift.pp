...
#
#  The storage nodes should also have some big partitions mounted in
#  /srv/swift-storage
...
#
# $ # upload:
# $ swift -A http://$PROXY_LOCAL_NET_IP:80/auth/v1.0 -U admin:admin -K <password
# from labs private> upload <containername> <filename>
# $ # download:
# $ swift -A http://$PROXY_LOCAL_NET_IP:80/auth/v1.0 -U admin:admin -K <password
# from labs private> download <containername>
