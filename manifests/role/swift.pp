...
# Make sure the rings are served up so that puppet on the swift nodes is installing them.  Also chown and chgrp 
# /srv/swift-storage/* to 'swift' on all storage nodes.
#
