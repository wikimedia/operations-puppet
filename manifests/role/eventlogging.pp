...
class role::eventlogging::processor::kafka inherits role::eventlogging {
    ...
    $kafka_consumer_args = "auto_commit_enable=True&auto_commit_interval_ms=10000&zookeeper_connect=${kafka_zookeeper_url}"
    ...
    $kafka_client_side_processors = [
        'client-side-events-kafka-0',
        'client-side-events-kafka-1',
        'client-side-events-kafka-2',
        'client-side-events-kafka-3',
        'client-side-events-kafka-4',
        'client-side-events-kafka-5',
        'client-side-events-kafka-6',
        'client-side-events-kafka-7',
    ]
