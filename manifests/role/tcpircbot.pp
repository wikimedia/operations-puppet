class role::tcpircbot {
    ...
    ferm::rule { 'tcpircbot_allowed':
        # eventlog1001, tin(v4), mira (v6), localhost, tin (v6), mira (v6)
        rule => 'proto tcp dport 9200 { saddr (10.64.32.167/32 10.64.0.196/32 10.192.16.132/32 127.0.0.1 2620:0:861:101:10:64:0:196/128 2620:0:860:102:10:192:16:132/128) ACCEPT; }',
    }
}
