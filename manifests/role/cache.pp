        ...
        varnish::instance { "text-backend":
            ...
            storage => $::realm ? {
                'production' => $::hostname ? {
                    ...
                    /^amssq(3[1-9]|4[0-6])$/ => "-s main1=persistent,/srv/sda/varnish.main1,100G -s main2=persistent,/srv/sdb3/varnish.main2,100G", # both are SDD
                    /^amssq(4[7-9]|[56][0-9])$/ => "-s main2=persistent,/srv/sdb3/varnish.main2,100G", # sda is an HDD, sdb is an SDD
