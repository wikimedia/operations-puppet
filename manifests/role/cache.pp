	...
	class configuration {
		$active_nodes = {
			...
			"bits" => {
				...
				"esams" => ["cp3001.esams.wikimedia.org", "cp3002.esams.wikimedia.org", "cp3019.esams.wikimedia.org", "cp3020.esams.wikimedia.org", "cp3021.esams.wikimedia.org", "cp3022.esams.wikimedia.org"],
			},
			"upload" => {
				"pmtpa" => [
					'sq41.wikimedia.org',
