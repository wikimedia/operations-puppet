...
class role::cache {
	...
	class bits {
		...
		$bits_appservers = [ "srv191.pmtpa.wmnet", "srv192.pmtpa.wmnet", "srv248.pmtpa.wmnet", "srv249.pmtpa.wmnet" ]
		$test_wikipedia = $::realm ? {
			"production" => [ "srv193.pmtpa.wmnet" ],
			"labs" => [ '10.4.0.166' ],
		}
		$all_backends = [ "srv191.pmtpa.wmnet", "srv192.pmtpa.wmnet", "srv248.pmtpa.wmnet", "srv249.pmtpa.wmnet", "srv193.pmtpa.wmnet" ]
