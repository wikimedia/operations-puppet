...
class role::cache {
	...
	class varnish::upload inherits role::cache::varnish::2layer {
      ...
      case $::realm {
        ...
        'labs': {
            default => "-s main1=persistent,/srv/vdb/varnish.main1,${storage_size_main}G -s main2=persistent,/srv/vdb/varnish.main2,${storage_size_main}G -s bigobj1=file,/srv/vdb/varnish.bigobj1,${storage_size_bigobj}G -s bigobj2=file,/srv/vdb/varnish.bigobj2,${storage_size_bigobj}G",
        }
      }
