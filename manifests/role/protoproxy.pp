...
class role::protoproxy::ssl {
    ...
    protoproxy{ 'wikimedia':
        proxy_addresses   => {
            ...
            'esams' => [ '91.198.174.192', '91.198.174.201', '[2620:0:862:ed1a::1:9]' ],
        },
        ...
        proxy_backend     => {
            ...
            'esams' => { 'primary' => '10.2.3.25', 'secondary' => $lvs::configuration::$lvs_service_ips[$::realm]['text-varnish'][$::mw_primary]['textlb'] },
        },
        ipv6_enabled       => true,
        enabled => true,
    ...
    protoproxy{ 'bits':
        ...
        proxy_backend => {
            ...
            'esams' => { 'primary' => '10.2.3.23', 'secondary' => $lvs::configuration::$lvs_service_ips[$::realm]['bits'][$::mw_primary]['bitslb'] },
        },
        ipv6_enabled => true,
        enabled => true,
    }
    protoproxy{ 'upload':
        ...
        proxy_backend => {
            ...
            'esams' => { 'primary' => '10.2.3.24', 'secondary' => $lvs::configuration::$lvs_service_ips[$::realm]['upload'][$::mw_primary]['uploadlb'] },
        },
        ipv6_enabled => true,
        enabled => true,
    }
    ...
    protoproxy{ 'mobilewikipedia':
        ...
        proxy_backend => {
            ...
            'esams' => { 'primary' => '10.2.3.26', 'secondary' => $lvs::configuration::$lvs_service_ips[$::realm]['mobile'][$::mw_primary]['mobilelb'] },
        },
        ipv6_enabled => true,
        enabled => true,
    }
    ...
    protoproxy{ 'videos':
        proxy_addresses => {
            ...
            proxy_backend => {
                ...
                'esams' => { 'primary' => '208.80.152.200', 'secondary' => $lvs::configuration::$lvs_service_ips[$::realm]['text-varnish'][$::mw_primary]['textlb'] },
            },
