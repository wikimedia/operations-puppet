...
class role::gerrit {
	...
	class labs {
		...
		class { "gerrit::instance":
			...
			ssl_key_file => "/etc/ssl/certs/gerrit-dev.wmflabs.org.pem",
			ssl_cert_file => "/etc/ssl/certs/gerrit-dev.wmflabs.org.pem"
		}
	}
	...
	class production {
		...
		class { "gerrit::instance":
			...
			ssl_key_file => "/etc/ssl/certs/star.wikimedia.org.pem",
