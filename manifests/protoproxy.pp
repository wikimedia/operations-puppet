define proxy_configuration( $proxy_addresses, $proxy_server_name, $proxy_server_cert_name, $proxy_backend, $enabled="false", $proxy_listen_flags='', $proxy_port='80' ) {
...
class protoproxy::proxy_sites {
	...
	proxy_configuration{ wikimedia:
		proxy_addresses => { "pmtpa" => [ "208.80.152.200", "[2620:0:860:2::80:2]" ],
		...
		proxy_backend => { "pmtpa" => { "primary" => "10.2.1.25" },
	...
	proxy_configuration{ bits:
		proxy_addresses => { "pmtpa" => [ "208.80.152.210", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wiktionary:
		proxy_addresses => { "pmtpa" => [ "208.80.152.202", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wikiquote:
		proxy_addresses => { "pmtpa" => [ "208.80.152.203", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wikibooks:
		proxy_addresses => { "pmtpa" => [ "208.80.152.204", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wikisource:
		proxy_addresses => { "pmtpa" => [ "208.80.152.205", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wikinews:
		proxy_addresses => { "pmtpa" => [ "208.80.152.206", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wikiversity:
		proxy_addresses => { "pmtpa" => [ "208.80.152.207", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ mediawiki:
		proxy_addresses => { "pmtpa" => [ "208.80.152.208", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ wikimediafoundation:
		proxy_addresses => { "pmtpa" => [ "208.80.152.209", "[2620:0:860:2::80:2]" ],
	...
	proxy_configuration{ gerrit:
		...
		proxy_server_cert_name => 'star.wikimedia.org',
		proxy_backend => { "pmtpa" => { "primary" => "208.80.152.147" },
