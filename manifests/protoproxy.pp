...
class protoproxy::proxy_sites {
	...
	proxy_configuration{ wikidata:
		proxy_addresses => {
			"pmtpa" => [ "127.0.0.1", "[2620:0:860:ed1a::c]" ],
			"eqiad" => [ "208.80.154.242", "[2620:0:861:ed1a::c]" ],
			"esams" => [ "127.0.0.1", "[2620:0:862:ed1a::c]" ]
		},
