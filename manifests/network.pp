...
class network::constants {
    ...
    [
     ...
     $all_network_subnets['production']['eqiad']['private']['private1-b-codfw']['ipv4'],
     $all_network_subnets['production']['eqiad']['private']['private1-c-codfw']['ipv4'],
     $all_network_subnets['production']['eqiad']['private']['private1-d-codfw']['ipv4'],
    ]
