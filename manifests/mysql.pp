...
class mysql {
	...
	### LVM snapshot hosts
	#######################################################################
	if $hostname =~ /^db(32|33|44|46|49|53|56|61|64|1005|1007|1018|1020|1022|1035|1046|1050)$/ {
		$snapshot_host = true
	}
	...
	#######################################################################
	if $hostname =~ /^db(32|36|38|59|60|61|62|63|67|1001|1017|1033|1042|1043|1047|1049|1050)$/ {
		$db_cluster = "s1"
	}
