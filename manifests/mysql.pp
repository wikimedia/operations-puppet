...
class mysql {
	...
	### LVM snapshot hosts 
	#######################################################################
	if $hostname =~ /^db(25|26|32|33|44|46|49|53|1005|1007|1018|1020|1022|1033|1035|1046)$/ {
		$snapshot_host = true
	}
	...
	#######################################################################
	if $hostname =~ /^db(12|32|36|38|42|59|60|61|62|63|1001|1017|1033|1042|1043|1047)$/ {
		$db_cluster = "s1"
	}
