...
class misc::deployment::l10nupdate {
	...
	file { '/usr/local/lib/nagios/plugins/check_l10n_cache':
	...
	nrpe::monitor_service { 'l10nupdate':
		...
		nrpe_command  => '/usr/local/lib/nagios/plugins/check_l10n_cache',
		require       => File['/usr/local/lib/nagios/plugins/check_l10n_cache'],
	}
