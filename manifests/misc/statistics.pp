...
class misc::statistics::site {
	...
	webserver::apache::site { $site_name: 
		...
		custom => [
			"Alias /extended $docroot/wikipedia.org/extended",
			"Alias /staff $docroot/wikipedia.org/staff \n",
			"RewriteEngine On",
	...
	"<Directory \"$docroot/wikipedia.org/staff\">
		AllowOverride None              
		Order allow,deny
		Allow from all
	...
	"<Directory \"$docroot/wikipedia.org/extended\">
		AllowOverride None              
		Order allow,deny
		Allow from all
		AuthName \"Password protected area\"
	...
	"<Directory \"$docroot/wikipedia.org/pediapress\">
		AllowOverride None              
		Order allow,deny
		Allow from all
		AuthName \"Password protected area\"
