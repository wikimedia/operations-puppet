...
# == Class misc::statistics::aggregator::projectcounts
# Aggregates hourly projectcounts files into daily per project csvs (and monitors them)
class misc::statistics::aggregator::projectcounts inherits misc::statistics::aggregator {
