...
class misc::torrus {
    ...
    include misc::torrus::xmlconfig
    include misc::torrus::discovery
}

class misc::torrus::web {
...
define misc::torrus::discovery::ddxfile(
    $subtree,
    $domain= '',
