...
class icinga::monitor::firewall {
    ...
    ferm::rule { 'ncsa_allowed':
        rule => 'saddr (127.0.0.1 $PMTPA_PRIVATE_PRIVATE_IPV4 $ESAMS_PRIVATE_PRIVATE1_ESAMS_IPV4 $EQIAD_PRIVATE_PRIVATE1_A_EQIAD_IPV4 $EQIAD_PRIVATE_PRIVATE1_B_EQIAD_IPV4 $ULSFO_PRIVATE_PRIVATE1_ULSFO_IPV4 $PMTPA_PRIVATE_VIRT_HOSTS_IPV4 $PMTPA_PUBLIC_PUBLIC_SERVICES_IPV4 $PMTPA_PUBLIC_PUBLIC_SERVICES_2_IPV4 $ESAMS_PUBLIC_PUBLIC_SERVICES_IPV4 $ULSFO_PUBLIC_PUBLIC1_ULSFO_IPV4 208.80.155.0/27 10.64.40.0/24) proto tcp dport 5667 ACCEPT;'
    }

    #snmptrap on port 162
    ferm::rule { 'snmptrap_allowed': rule => 'saddr (127.0.0.1 $PMTPA_PRIVATE_PRIVATE_IPV4 $ESAMS_PRIVATE_PRIVATE1_ESAMS_IPV4 $EQIAD_PRIVATE_PRIVATE1_A_EQIAD_IPV4 $EQIAD_PRIVATE_PRIVATE1_B_EQIAD_IPV4 $ULSFO_PRIVATE_PRIVATE1_ULSFO_IPV4 $PMTPA_PRIVATE_VIRT_HOSTS_IPV4 $PMTPA_PUBLIC_PUBLIC_SERVICES_IPV4 $PMTPA_PUBLIC_PUBLIC_SERVICES_2_IPV4 $ESAMS_PUBLIC_PUBLIC_SERVICES_IPV4 $ULSFO_PUBLIC_PUBLIC1_ULSFO_IPV4 208.80.155.0/27 10.64.40.0/24) proto udp dport 162 ACCEPT;'
    }
}
