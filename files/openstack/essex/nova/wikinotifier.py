...
class WikiStatus(object):
	...
	ctxt = context.get_admin_context()
        ...
        if event_type == 'compute.instance.delete.end':
            page_string = "\n%s\n%s\n%s\n" % (begin_comment, _("This instance has been deleted."), end_comment)
	else:
            template_param_dict = {}
            ...
            #image = self.glance_service.show(ctxt, db.s3_image_get_by_uuid(ctxt, inst.image_ref).id)
