...
#
    ...
    for i in range(0, len(expression)):
        ...
        elif (expression[i] is True or expression[i] is False) and len(expression) != 1:
            if expression[i + 1] == 'and':
                if expression[i] is False:
                    return False
                elif expression[i + 2] is True or expression[i + 2] is False:
