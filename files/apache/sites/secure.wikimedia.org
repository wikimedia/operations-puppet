<VirtualHost *:443>
	...
	RewriteRule ^/wikipedia/(meta|commons|incubator|species|outreach|strategy|usability|wikimania|survey|office)/(w|wiki)/(.*)$ https://$1.wikimedia.org/$2/$3 [R=301,L]
	RewriteRule ^/(wikipedia|wikinews|wikisource|wikibooks|wikiquote|wikiversity|wiktionary)/([^@:/]+)/(w|wiki)/(.*)$ https://$2.$1.org/$3/$4 [R=301,L]
